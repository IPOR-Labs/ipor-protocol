...
function create_env_config_file(){
  ...
  RESULT=$(set_smart_contract_address_from_json_file "DaiTestnetMockedToken.json" "dai_mocked_address")
  RESULT=$(set_smart_contract_address_from_json_file "UsdcTestnetMockedToken.json" "usdc_mocked_address")
  RESULT=$(set_smart_contract_address_from_json_file "UsdtTestnetMockedToken.json" "usdt_mocked_address")
