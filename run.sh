...
function create_env_config_file(){
  ...
  RESULT=$(set_smart_contract_address_from_json_file "ItfMilton.json" "milton_test_address")
  RESULT=$(set_smart_contract_address_from_json_file "ItfWarren.json" "warren_test_address")
  RESULT=$(set_smart_contract_address_from_json_file "ItfJoseph.json" "joseph_test_address")
