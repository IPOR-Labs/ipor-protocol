        ...
        <table className="table">
            <tr>
                ...
                <th scope="col">
                    USDT
                    <br />
                    <small>{drizzle.contracts.UsdtTestnetMockedToken.address}</small>
                </th>
                <th scope="col">
                    USDC
                    <br />
                    <small>{drizzle.contracts.UsdcTestnetMockedToken.address}</small>
                </th>
                <th scope="col">
                    DAI
                    <br />
                    <small>{drizzle.contracts.DaiTestnetMockedToken.address}</small>
                </th>
            </tr>
            <tr>
