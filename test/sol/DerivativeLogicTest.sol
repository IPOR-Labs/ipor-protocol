...
contract DerivativeLogicTest is TestData {
    ...
    function testCalculateInterestFixedCase1() public {
        ...
        //then
        Assert.equal(AmmMath.division(result, Constants.YEAR_IN_SECONDS * multiplicator), notionalAmount, "Wrong interest fixed");
    }
    ...
    function testCalculateInterestFixedCase2() public {
        ...
        //then
        Assert.equal(AmmMath.division(result, Constants.YEAR_IN_SECONDS * multiplicator), 99005869479452054794521, "Wrong interest fixed");
    }
    ...
    function testCalculateInterestFixedCase3() public {
        ...
        //then
        Assert.equal(AmmMath.division(result, Constants.YEAR_IN_SECONDS * multiplicator), 102651120000000000000000, "Wrong interest fixed");
    }
    ...
    function testCalculateInterestFixedCase5() public {
        ...
        //then
        Assert.equal(AmmMath.division(result, Constants.YEAR_IN_SECONDS * multiplicator), 99005869479, "Wrong interest fixed");
    }
    ...
    function testCalculateInterestFixedCase6() public {
        ...
        //then
        Assert.equal(AmmMath.division(result, Constants.YEAR_IN_SECONDS * multiplicator), 102651120000, "Wrong interest fixed");
    }
    ...
    function testCalculateInterestFloatingCase1() public {
        ...
        //then
        Assert.equal(AmmMath.division(result, Constants.YEAR_IN_SECONDS * Constants.D18), 98703 * Constants.D18, "Wrong interest floating");
    }
    ...
    function testCalculateInterestFloatingCase2() public {
        ...
        //then
        Assert.equal(AmmMath.division(result, Constants.YEAR_IN_SECONDS * Constants.D18), 148054500000000000000000, "Wrong interest floating");
    }
    ...
    function testCalculateInterestFloatingCase3() public {
        ...
        //then
        Assert.equal(AmmMath.division(result, Constants.YEAR_IN_SECONDS * Constants.D6), 98703 * Constants.D6, "Wrong interest floating");
    }
    ...
    function testCalculateInterestFloatingCase4() public {
        ...
        //then
        Assert.equal(AmmMath.division(result, Constants.YEAR_IN_SECONDS * Constants.D6), 148054500000, "Wrong interest floating");
    }
    ...
    function testCalculateInterestCase1() public {
        ...
        Assert.equal(AmmMath.division(derivativeInterest.quasiInterestFloating, Constants.YEAR_IN_SECONDS * Constants.D18), 98703 * Constants.D18, "Wrong interest floating");
    ...
    function testCalculateInterestCase2() public {
        ...
        DataTypes.IporDerivative memory derivative = prepareDerivativeCase2(fixedInterestRate);
        ...
        Assert.equal(AmmMath.division(derivativeInterest.quasiInterestFloating, Constants.YEAR_IN_SECONDS * Constants.D6), 98703 * Constants.D6, "Wrong interest floating");
        Assert.equal(derivativeInterest.positionValue, 0, "Wrong interest difference amount");
    }

    function testCalculateInterestCase2SameTimestampIBTPriceIncreaseDecimal18Case1() public {
        ...
        //then
        Assert.equal(AmmMath.division(derivativeInterest.quasiInterestFixed, Constants.YEAR_IN_SECONDS * Constants.D18), 98703 * Constants.D18, "Wrong interest fixed");
        Assert.equal(AmmMath.division(derivativeInterest.quasiInterestFloating, Constants.YEAR_IN_SECONDS * Constants.D18), 123378750000000000000000, "Wrong interest floating");
        Assert.equal(derivativeInterest.positionValue, 24675750000000000000000, "Wrong interest difference amount");
    }

    function testCalculateInterestCase2SameTimestampIBTPriceIncreaseDecimal6Case2() public {
        ...
        //then
        Assert.equal(AmmMath.division(derivativeInterest.quasiInterestFixed, Constants.YEAR_IN_SECONDS * Constants.D6), 98703 * Constants.D6, "Wrong interest fixed");
        Assert.equal(AmmMath.division(derivativeInterest.quasiInterestFloating, Constants.YEAR_IN_SECONDS * Constants.D6), 123378750000, "Wrong interest floating");
        Assert.equal(derivativeInterest.positionValue, 24675750000, "Wrong interest difference amount");
    }

    function testCalculateInterestCase25daysLaterIBTPriceNotChangedDecimal18() public {
        ...
        Assert.equal(AmmMath.division(derivativeInterest.quasiInterestFloating, Constants.YEAR_IN_SECONDS * Constants.D18), 98703000000000000000000, "Wrong interest floating");
        Assert.equal(derivativeInterest.positionValue, - 270419178082191780821, "Wrong interest difference amount");
    }

    function testCalculateInterestCase25daysLaterIBTPriceNotChangedDecimal6() public {
        ...
        Assert.equal(AmmMath.division(derivativeInterest.quasiInterestFloating, Constants.YEAR_IN_SECONDS * Constants.D6), 98703000000, "Wrong interest floating");
        Assert.equal(derivativeInterest.positionValue, - 270419177, "Wrong interest difference amount");
    }

    function testCalculateInterestCase25daysLaterIBTPriceChangedDecimals18() public {
    ...
    function testCalculateInterestCase25daysLaterIBTPriceChangedDecimals6() public {
        ...
        Assert.equal(AmmMath.division(derivativeInterest.quasiInterestFixed, Constants.YEAR_IN_SECONDS * Constants.D6), 98973419178, "Wrong interest fixed");
        Assert.equal(AmmMath.division(derivativeInterest.quasiInterestFloating, Constants.YEAR_IN_SECONDS * Constants.D6), 123378750000, "Wrong interest floating");
        Assert.equal(derivativeInterest.positionValue, 24405330822, "Wrong interest difference amount");
    }

    function testCalculateInterestCaseHugeIpor25daysLaterIBTPriceChangedUserLosesDecimals18() public {
    ...
    function testCalculateInterestCaseHugeIpor25daysLaterIBTPriceChangedUserLosesDecimals6() public {
        ...
        Assert.equal(AmmMath.division(derivativeInterest.quasiInterestFloating, Constants.YEAR_IN_SECONDS * Constants.D6), 123378750000, "Wrong interest floating");
        Assert.equal(derivativeInterest.positionValue, - 67604794, "Wrong interest difference amount");
    }


    function testCalculateInterestCase100daysLaterIBTPriceNotChangedDecimals18() public {
    ...
    function testCalculateInterestCase100daysLaterIBTPriceNotChangedDecimals6() public {
        ...
        Assert.equal(AmmMath.division(derivativeInterest.quasiInterestFloating, Constants.YEAR_IN_SECONDS * Constants.D6), 98703000000, "Wrong interest floating");
        Assert.equal(derivativeInterest.positionValue, - 302869478, "Wrong interest difference amount");
    }
