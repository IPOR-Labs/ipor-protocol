...
contract AmmUnwindSwap is TestCommons {
    ...
    function testShouldUnwindPayFixedSimple() public {
        ...
        _iporProtocol.ammCloseSwapServiceDai.closeSwapsDai(_buyer, swapPfIds, swapRfIds, closeSwapRiskIndicatorsInput);
    ...
    function testShouldUnwindPayFixedWhenCloseTwoPositionInDifferentMoment() public {
        ...
        _iporProtocol.ammCloseSwapServiceDai.closeSwapsDai(
            _buyer,
            swapPfIds,
            new uint256[](0),
