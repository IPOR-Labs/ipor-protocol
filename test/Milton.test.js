...
contract('Milton', (accounts) => {
    ...
    //     await iporLiquidityPool.provideLiquidity(params.asset, miltonBalanceBeforePayout, {from: liquidityProvider})
    //
    ...
    //     }
    //     await warren.test_updateIndex(derivativeParamsFirst.asset, iporValueBeforeOpenPosition, derivativeParamsFirst.openTimestamp, {from: userOne});
    //     await iporLiquidityPool.provideLiquidity(derivativeParamsFirst.asset, testUtils.MILTON_14_000_USD + testUtils.MILTON_14_000_USD, {from: liquidityProvider})
    //     await openPositionFunc(derivativeParamsFirst);
    //
    ...
    it('should close position with appropriate balance, DAI, owner, pay fixed, Milton lost, User earned < Deposit, after maturity, IPOR index calculated before close', async () => {
        ...
        await warren.test_updateIndex(params.asset, iporValueAfterOpenPosition, endTimestamp, {from: userOne});
    ...
    // //
    // //     await iporLiquidityPool.provideLiquidity(derivativeParams.asset, BigInt(3) * testUtils.MILTON_14_000_USD, {from: liquidityProvider})
    // //
    // //     //when
    ...
    // //         from: userThree
    // //     }
    // //     await iporLiquidityPool.provideLiquidity(derivativeParams.asset, BigInt(2) * testUtils.MILTON_14_000_USD, {from: liquidityProvider});
    // //     await warren.test_updateIndex(derivativeParams.asset, iporValueBeforeOpenPosition, derivativeParams.openTimestamp, {from: userOne});
    // //
    ...
    //     await exetuceClosePositionTestCase(
    //         tokenDai.address, testUtils.MILTON_10_USD, 1, userTwo, userThree,
    ...
    //     await setupTokenDaiInitialValues();
    //     await miltonConfiguration.setIncomeTaxPercentage(testUtils.MILTON_5_PERCENTAGE);
    //     let incomeTax = BigInt("6305909090909090909090");
    ...
    //
    //     let expectedOpenerUserTokenBalanceAfterPayOut = BigInt("9991882391033623910305200");
    //     let expectedCloserUserTokenBalanceAfterPayOut = BigInt("9991882391033623910305200");
    //
    //     let miltonBalanceBeforePayout = testUtils.MILTON_14_000_USD;
    //     let expectedMiltonTokenBalance = miltonBalanceBeforePayout + BigInt("8117608966376089694800");
    //     let expectedLiquidityPoolTotalBalance = miltonBalanceBeforePayout + BigInt("8117608966376089694800") - incomeTax;
    //
    //     await exetuceClosePositionTestCase(
    //         tokenDai.address, testUtils.MILTON_10_USD, 0, userTwo, userTwo,
    //         testUtils.MILTON_120_PERCENTAGE,
    ...
    //     let expectedLiquidityPoolTotalBalance = miltonBalanceBeforePayout + testUtils.MILTON_90_63_USD - incomeTax;
    //
    //     await exetuceClosePositionTestCase(
    //         tokenDai.address, testUtils.MILTON_10_USD, 1, userTwo, userThree,
    //         testUtils.MILTON_5_PERCENTAGE, testUtils.MILTON_160_PERCENTAGE, testUtils.PERIOD_50_DAYS_IN_SECONDS,
    ...
    //     let miltonBalanceBeforePayout = testUtils.MILTON_14_000_USD;
    //     let expectedMiltonTokenBalance = miltonBalanceBeforePayout + BigInt("9980000000000000000000");
    //     let expectedLiquidityPoolTotalBalance = miltonBalanceBeforePayout + BigInt("906363636363636363636") - incomeTax;
    //
    //     await exetuceClosePositionTestCase(
    //         tokenDai.address, testUtils.MILTON_10_USD, 1, userTwo, userThree,
    //         testUtils.MILTON_5_PERCENTAGE, testUtils.MILTON_160_PERCENTAGE, testUtils.PERIOD_50_DAYS_IN_SECONDS,
    ...
    //     let incomeTax = BigInt("0");
    //
    //     let expectedOpenerUserTokenBalanceAfterPayOut = BigInt("9999083636363636363636364");
    //     let expectedCloserUserTokenBalanceAfterPayOut = BigInt("9999083636363636363636364");
    //
    //
    //     let miltonBalanceBeforePayout = testUtils.MILTON_14_000_USD;
    //     let expectedMiltonTokenBalance = miltonBalanceBeforePayout + BigInt("916363636363636363636");
    //     let expectedLiquidityPoolTotalBalance = miltonBalanceBeforePayout + BigInt("883704545454545454545") - incomeTax;
    //
    //     await exetuceClosePositionTestCase(
    //         tokenDai.address, BigInt("10000000000000000000"), 0, userTwo, userTwo,
    //         testUtils.MILTON_3_PERCENTAGE, testUtils.MILTON_3_PERCENTAGE, 0,
    //         miltonBalanceBeforePayout,
    //         expectedMiltonTokenBalance,
    //         expectedOpenerUserTokenBalanceAfterPayOut,
    ...
    const exetuceClosePositionTestCase = async function (
        ...
        if (providedLiquidityAmount != null) {
            //in test we expect that Liquidity Pool is loosing and from its pool Milton has to paid out to closer user
            await iporLiquidityPool.provideLiquidity(params.asset, providedLiquidityAmount, {from: liquidityProvider})
        }
