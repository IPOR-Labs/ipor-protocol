...
//
//        AmmTypesGenOne.sol.RiskIndicatorsInputs memory riskIndicatorsInputs = AmmTypesGenOne.sol.RiskIndicatorsInputs({
...
//        // when
//        vm.prank(user);
//        IAmmOpenSwapService(iporProtocolRouterProxy).openSwapPayFixed28daysUsdc(user, 10_000e6, 1e18, 10e18, riskIndicatorsInputs);
//
//        (uint256 totalCount, IAmmSwapsLens.IporSwap[] memory swaps) = IAmmSwapsLens(iporProtocolRouterProxy).getSwaps(
//            USDC,
//            user,
