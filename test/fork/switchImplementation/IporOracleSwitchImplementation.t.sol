...
contract SwitchIporOracleImplementation is Test, TestCommons {
    ...
    function testShouldUpgradeImplementationCheckDai() public {
        ...
        iporOracleSnapshotStart.assert(iporOracleSnapshotStart, iporOracleSnapshotAfterUpgrade);
    }
    ...
    function testShouldUpdateIndexForDaiWhenUpgradeImplementation() public {
        ...
        //assert
        cleanAfterUpdateIndex.assert(cleanAfterUpdateIndex, newImplAfterUpdateIndex);
    }
