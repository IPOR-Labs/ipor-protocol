...
contract DaiSwitchIporProtocolImplementation is Test, TestCommons {
    ...
    // without any actions
    string private constant INIT_SNAPSHOT_FILE_NAME = "/iporOracleSnapshotStart.json";
    string private constant CLEAN_AFTER_UPDATE_IMPLEMENTATION_SNAPSHOT_FILE_NAME = "/iporOracleSnapshotAfterUpdateImpl.json";

    string private constant SNAPSHOT_AFTER_UPDATE_INDEX_OLD_IMPL_FILE_NAME = "/iporOracleSnapshotOldImplAfterUpdateIndexAndPause.json";
    string private constant SNAPSHOT_AFTER_UPDATE_INDEX_New_IMPL_FILE_NAME = "/iporOracleSnapshotNiewImplAfterUpdateIndexAndPause.json";
