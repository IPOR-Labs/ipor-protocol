...
contract ItfMiltonSpreadModelTest is TestCommons {
	...
	function testShouldCheckIfSetupMethodWorksForDAI() public {
		...
		spreadModelParamsBefore.payFixedRegionOneSlopeForVolatility = _iftMiltonSpreadModelDai.getPayFixedRegionOneSlopeForVolatility();
		spreadModelParamsBefore.payFixedRegionOneSlopeForMeanReversion = _iftMiltonSpreadModelDai.getPayFixedRegionOneSlopeForMeanReversion();
		spreadModelParamsBefore.payFixedRegionTwoBase = _iftMiltonSpreadModelDai.getPayFixedRegionTwoBase();
		spreadModelParamsBefore.payFixedRegionTwoSlopeForVolatility = _iftMiltonSpreadModelDai.getPayFixedRegionTwoSlopeForVolatility();
		spreadModelParamsBefore.payFixedRegionTwoSlopeForMeanReversion = _iftMiltonSpreadModelDai.getPayFixedRegionTwoSlopeForMeanReversion();
		spreadModelParamsBefore.receiveFixedRegionOneBase = _iftMiltonSpreadModelDai.getReceiveFixedRegionOneBase();
		spreadModelParamsBefore.receiveFixedRegionOneSlopeForVolatility = _iftMiltonSpreadModelDai.getReceiveFixedRegionOneSlopeForVolatility();
		spreadModelParamsBefore.receiveFixedRegionOneSlopeForMeanReversion = _iftMiltonSpreadModelDai.getReceiveFixedRegionOneSlopeForMeanReversion();
		spreadModelParamsBefore.receiveFixedRegionTwoBase = _iftMiltonSpreadModelDai.getReceiveFixedRegionTwoBase();
		spreadModelParamsBefore.receiveFixedRegionTwoSlopeForVolatility = _iftMiltonSpreadModelDai.getReceiveFixedRegionTwoSlopeForVolatility();
		spreadModelParamsBefore.receiveFixedRegionTwoSlopeForMeanReversion = _iftMiltonSpreadModelDai.getReceiveFixedRegionTwoSlopeForMeanReversion();
		// when
		...
		spreadModelParamsAfter.payFixedRegionOneSlopeForVolatility = _iftMiltonSpreadModelDai.getPayFixedRegionOneSlopeForVolatility();
		spreadModelParamsAfter.payFixedRegionOneSlopeForMeanReversion = _iftMiltonSpreadModelDai.getPayFixedRegionOneSlopeForMeanReversion();
		spreadModelParamsAfter.payFixedRegionTwoBase = _iftMiltonSpreadModelDai.getPayFixedRegionTwoBase();
		spreadModelParamsAfter.payFixedRegionTwoSlopeForVolatility = _iftMiltonSpreadModelDai.getPayFixedRegionTwoSlopeForVolatility();
		spreadModelParamsAfter.payFixedRegionTwoSlopeForMeanReversion = _iftMiltonSpreadModelDai.getPayFixedRegionTwoSlopeForMeanReversion();
		spreadModelParamsAfter.receiveFixedRegionOneBase = _iftMiltonSpreadModelDai.getReceiveFixedRegionOneBase();
		spreadModelParamsAfter.receiveFixedRegionOneSlopeForVolatility = _iftMiltonSpreadModelDai.getReceiveFixedRegionOneSlopeForVolatility();
		spreadModelParamsAfter.receiveFixedRegionOneSlopeForMeanReversion = _iftMiltonSpreadModelDai.getReceiveFixedRegionOneSlopeForMeanReversion();
		spreadModelParamsAfter.receiveFixedRegionTwoBase = _iftMiltonSpreadModelDai.getReceiveFixedRegionTwoBase();
		spreadModelParamsAfter.receiveFixedRegionTwoSlopeForVolatility = _iftMiltonSpreadModelDai.getReceiveFixedRegionTwoSlopeForVolatility();
		spreadModelParamsAfter.receiveFixedRegionTwoSlopeForMeanReversion = _iftMiltonSpreadModelDai.getReceiveFixedRegionTwoSlopeForMeanReversion();
