...
contract MiltonShouldNotOpenPositionTest is
    Test,
    TestCommons,
    DataUtils,
    SwapUtils
{
	...
	function testShouldNotOpenPositionWhenTotalAmountIsTooLow() public {
		...
		openSwapPayFixed(_userTwo, block.timestamp, TestConstants.ZERO, TestConstants.PERCENTAGE_3_18DEC, TestConstants.LEVERAGE_18DEC, mockCase0MiltonDai);
	}
	...
	function testShouldNotOpenPositionWhenTotalAmountIsGreaterThanAssetBalance() public {
		...
		openSwapPayFixed(_userTwo, block.timestamp, TestConstants.USER_SUPPLY_10MLN_18DEC + 3, TestConstants.PERCENTAGE_3_18DEC, TestConstants.LEVERAGE_18DEC, mockCase0MiltonDai);
	}
	...
	function testShouldNotOpenPositionWhenAcceptableFixedInterestRateIsExceededInPayFixed() public {
		...
		openSwapPayFixed(_userTwo, block.timestamp, TestConstants.TC_TOTAL_AMOUNT_10_000_18DEC, 39999999999999999, TestConstants.LEVERAGE_18DEC, mockCase0MiltonDai);
	}
	...
	function testShouldNotOpenPositionWhenAcceptableFixedInterestRateIsExceededInReceiveFixed18Decimals() public {
		...
		// when
		vm.expectRevert("IPOR_313");
		openSwapReceiveFixed(_userTwo, block.timestamp, TestConstants.TC_TOTAL_AMOUNT_10_000_18DEC, TestConstants.D16 + 48374213950104766, TestConstants.LEVERAGE_18DEC, mockCase0MiltonDai);
	}
	...
	function testShouldNotOpenPositionWhenAcceptableFixedInterestRateIsExceededInPayFixed6Decimals() public {
		...
		// when
		vm.expectRevert("IPOR_313");
		openSwapPayFixed(_userTwo, block.timestamp, TestConstants.TC_TOTAL_AMOUNT_10_000_6DEC, 39999999999999999, TestConstants.LEVERAGE_18DEC, mockCase0MiltonUsdt);
	}
	...
	function testShouldNotOpenPositionWhenAcceptableFixedInterestRateIsExceededInReceiveFixed6Decimals() public {
		...
		// when
		vm.expectRevert("IPOR_313");
		openSwapReceiveFixed(_userTwo, block.timestamp, TestConstants.TC_TOTAL_AMOUNT_10_000_6DEC, 48374213950069062, TestConstants.LEVERAGE_18DEC, mockCase0MiltonUsdt);
	}
	...
	function testShouldNotOpenPositionWhenTotalAmountIsTooHighCaseOne() public {
		...
		openSwapPayFixed(_userTwo, block.timestamp, 1000000000000000000000001, TestConstants.PERCENTAGE_3_18DEC, TestConstants.LEVERAGE_18DEC, mockCase0MiltonDai);
	}
	...
	function testShouldNotOpenPositionWhenTotalAmountIsTooHighCaseTwo() public {
		...
		// when
		vm.expectRevert("IPOR_312");
		openSwapPayFixed(_userTwo, block.timestamp, 100688870576704582165765, TestConstants.PERCENTAGE_3_18DEC, TestConstants.LEVERAGE_18DEC, mockCase0MiltonDai);
	}
	...
	function testShouldNotOpenPositionWhenLiquidityPoolBalanceIsTooLow() public {
		...
		openSwapPayFixed(_userTwo, block.timestamp, TestConstants.TC_TOTAL_AMOUNT_10_000_18DEC, 9 * TestConstants.D17, TestConstants.LEVERAGE_18DEC, mockCase0MiltonDai);
		vm.prank(_userOne);
