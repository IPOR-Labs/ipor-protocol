...
contract MiltonShouldCalculateTest is Test, TestCommons, MiltonUtils, MiltonStorageUtils, JosephUtils, IporOracleUtils, DataUtils, SwapUtils, StanleyUtils {
	...
	function testShouldCalculateIncomeFeeFivePercentWhenReceiveFixedAndMiltonLosesAndUserEarnsAndDepositIsGreaterThanDifferenceBetweenLegsAfterMaturity() public {
		// given
		...
		assertEq(_daiMockedToken.balanceOf(address(mockCase2MiltonDai)), 28000*Constants.D18 + 2990102969109267220 + 10*Constants.D18 - 682671910755540429746 + 34133595537777021487); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC - expectedPayoffAbs + expectedIncomeFeeValue
	...
	function testShouldCalculateIncomeFeeFivePercentWhenPayFixedAndMiltonLosesAndUserEarnsAndDepositIsLowerThanDifferenceBetweenLegsBeforeMaturity() public {
		// given
		...
		assertEq(_daiMockedToken.balanceOf(address(mockCase2MiltonDai)), 28000*Constants.D18 + 2990102969109267220 + 10*Constants.D18 - 9967009897030890732780 + 498350494851544536639); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC - expectedPayoffAbs + expectedIncomeFeeValue
		assertEq(int256(_daiMockedToken.balanceOf(_userTwo)), 10*10**6*Constants.D18_INT + 0 - openerUserLost); // USER_SUPPLY_10MLN_18_DEC + openerUserEarned - openerUserLost
		assertEq(int256(_daiMockedToken.balanceOf(_userThree)), 10*10**6*Constants.D18_INT + 20*Constants.D18_INT - 0); // USER_SUPPLY_10MLN_18_DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - closerUserLost
	...
	function testShouldCalculateIncomeFeeFivePercentWhenPayFixedAndMiltonEarnsAndUserLosesAndDepositIsGreaterThanDifferenceBetweenLegsBeforeMaturity() public {
		// given
		...
		vm.prank(_liquidityProvider);
		mockCase0JosephDai.itfProvideLiquidity(28000*Constants.D18, block.timestamp); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC
		openSwapPayFixed(_userTwo, block.timestamp, 10000*Constants.D18, 121*10**16, 10*Constants.D18, mockCase2MiltonDai);
		vm.prank(_userOne);
		iporOracle.itfUpdateIndex(address(_daiMockedToken), 5*10**16, block.timestamp); // PERCENTAGE_5_18DEC
		...
		assertEq(_daiMockedToken.balanceOf(address(mockCase2MiltonDai)), 28000*Constants.D18 + 2990102969109267220 + 10*Constants.D18 + 7918994164764269383465); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + expectedPayoffAbs
		...
		assertEq(balance.totalCollateralPayFixed, 0); 
		assertEq(balance.iporPublicationFee, 10*Constants.D18);
		assertEq(balance.liquidityPool, 28000*Constants.D18 + 2990102969109267220 +  7918994164764269383465 - 395949708238213469173); // miltonBalanceBeforePayoutWad + TC_OPENING_FEE_18DEC + expectedPayoffAbs - expectedIncomeFeeValue
		assertEq(balance.treasury, 395949708238213469173);
		assertEq(28000*Constants.D18 + 10*10**6*Constants.D18 + 10*10**6*Constants.D18, _daiMockedToken.balanceOf(address(mockCase2MiltonDai))  + _daiMockedToken.balanceOf(_userTwo) + _daiMockedToken.balanceOf(_userThree)); // expectedSumOfBalancesBeforePayout(miltonBalanceBeforePayout + openerUserUnderlyingTokenBalanceBeforePayout + closeUserUnderlyingTokenBalanceBeforePayout) vs actualSumOfBalancesBeforePayout(openerUserUnderlyingTokenBalanceBeforePayout + closeUserUnderlyingTokenBalanceAfterPayout + closerUserUnderlyingTokenBalanceAfterPayout + miltonUnderlyingTokenBalanceAfterPayout)
		assertEq(soap, 0);
	}

	function testShouldCalculateIncomeFeeFivePercentWhenReceiveFixedAndMiltonEarnsAndUserLosesAndDepositIsLowerThanDifferenceBetweenLegsAfterMaturity() public {
		// given
		...
		vm.prank(_liquidityProvider);
		mockCase0JosephDai.itfProvideLiquidity(28000*Constants.D18, block.timestamp); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC
		openSwapReceiveFixed(_userTwo, block.timestamp, 10000*Constants.D18, 4*10**16, 10*Constants.D18, mockCase2MiltonDai);
		vm.prank(_userOne);
		iporOracle.itfUpdateIndex(address(_daiMockedToken), 160*10**16, block.timestamp); // PERCENTAGE_160_18DEC
		...
		assertEq(actualPayoff, -9967009897030890732780); // expectedPayoff
		assertEq(actualIncomeFeeValue, 498350494851544536639); // expectedIncomeFeeValue
		assertEq(_daiMockedToken.balanceOf(address(mockCase2MiltonDai)), 28000*Constants.D18 + 2990102969109267220 + 10*Constants.D18 + 9967009897030890732780); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + expectedPayoffAbs
		assertEq(int256(_daiMockedToken.balanceOf(_userTwo)), 10*10**6*Constants.D18_INT + 20*Constants.D18_INT - openerUserLost); // USER_SUPPLY_10MLN_18_DEC + openerUserEarned - openerUserLost
		assertEq(balance.totalCollateralPayFixed, 0); 
		assertEq(balance.iporPublicationFee, 10*Constants.D18);
		assertEq(balance.liquidityPool, 28000*Constants.D18 + 2990102969109267220 +  9967009897030890732780 - 498350494851544536639); // miltonBalanceBeforePayoutWad + TC_OPENING_FEE_18DEC + expectedPayoffAbs - expectedIncomeFeeValue
		assertEq(balance.treasury, 498350494851544536639);
		assertEq(28000*Constants.D18 + 10*10**6*Constants.D18 + 10*10**6*Constants.D18, _daiMockedToken.balanceOf(address(mockCase2MiltonDai))  + _daiMockedToken.balanceOf(_userTwo) + _daiMockedToken.balanceOf(_userThree)); // expectedSumOfBalancesBeforePayout(miltonBalanceBeforePayout + openerUserUnderlyingTokenBalanceBeforePayout + closeUserUnderlyingTokenBalanceBeforePayout) vs actualSumOfBalancesBeforePayout(openerUserUnderlyingTokenBalanceBeforePayout + closeUserUnderlyingTokenBalanceAfterPayout + closerUserUnderlyingTokenBalanceAfterPayout + miltonUnderlyingTokenBalanceAfterPayout)
		assertEq(soap, 0);
	}

	function testShouldCalculateIncomeFeeOneHundredPercentWhenReceiveFixedAndMiltonLosesAndUserEarnsAndDepositIsGreaterThanDifferenceBetweenLegsAfterMaturity() public {
		// given
		_miltonSpreadModel.setCalculateQuoteReceiveFixed(10*10**16);
		ItfIporOracle iporOracle = getIporOracleOneAsset(_admin, _userOne, address(_daiMockedToken), 120*10**16); 
		MockCase1Stanley stanleyDai = getMockCase1Stanley(address(_daiMockedToken));
		(ProxyTester miltonStorageDaiProxy, MiltonStorage miltonStorageDai) = getMiltonStorage(_admin);
		(ProxyTester mockCase3MiltonDaiProxy, MockCase3MiltonDai mockCase3MiltonDai) = getMockCase3MiltonDai(_admin, address(_daiMockedToken), address(iporOracle), address(miltonStorageDai), address(_miltonSpreadModel), address(stanleyDai));
		(ProxyTester mockCase0JosephDaiProxy, MockCase0JosephDai mockCase0JosephDai) = getMockCase0JosephDai(_admin, address(_daiMockedToken), address(_ipTokenDai), address(mockCase3MiltonDai), address(miltonStorageDai), address(stanleyDai));
		address[] memory users = getFiveUsers(_admin, _userOne, _userTwo, _userThree, _liquidityProvider);
		prepareApproveForUsersDai(users, _daiMockedToken, address(mockCase0JosephDai), address(mockCase3MiltonDai));
		prepareMiltonStorage(miltonStorageDai, miltonStorageDaiProxy, address(mockCase0JosephDai), address(mockCase3MiltonDai));
		prepareMockCase3MiltonDai(mockCase3MiltonDai, address(mockCase3MiltonDaiProxy), address(mockCase0JosephDai), address(stanleyDai));
		prepareMockCase0JosephDai(mockCase0JosephDai, address(mockCase0JosephDaiProxy));
		prepareIpTokenDai(_ipTokenDai, address(mockCase0JosephDai));
		vm.prank(_liquidityProvider);
		mockCase0JosephDai.itfProvideLiquidity(28000*Constants.D18, block.timestamp); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC
		openSwapReceiveFixed(_userTwo, block.timestamp, 10000*Constants.D18, 10*10**16, 10*Constants.D18, mockCase3MiltonDai);
		vm.prank(_userOne);
		iporOracle.itfUpdateIndex(address(_daiMockedToken), 5*10**16, block.timestamp); // PERCENTAGE_5_18DEC
		int256 openerUserLost = 2990102969109267220 + 10*Constants.D18_INT + 20*Constants.D18_INT - 682671910755540429746 + 682671910755540429746; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - expectedPayoffAbs + expectedIncomeFeeValue
		// when
		vm.prank(_userTwo); // openerUser
		int256 actualPayoff = mockCase3MiltonDai.itfCalculateSwapReceiveFixedValue(block.timestamp + 4320000, 1);
		vm.prank(_userThree); // closerUser
		mockCase3MiltonDai.itfCloseSwapReceiveFixed(1, block.timestamp + 4320000);
		vm.prank(_userThree); // closerUser
		...
		vm.prank(address(miltonStorageDaiProxy));
		(, IporTypes.IporSwapMemory[] memory swaps) = miltonStorageDai.getSwapsReceiveFixed(_userTwo, 0, 50);
        (,, int256 soap) =  calculateSoap(_userTwo, block.timestamp + 4320000, mockCase3MiltonDai);
		assertEq(0, swaps.length);
		assertEq(actualPayoff, 682671910755540429746); // expectedPayoff
		assertEq(actualIncomeFeeValue, 682671910755540429746); // expectedIncomeFeeValue
		assertEq(_daiMockedToken.balanceOf(address(mockCase3MiltonDai)), 28000*Constants.D18 + 2990102969109267220 + 10*Constants.D18 - 682671910755540429746 + 682671910755540429746); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC - expectedPayoffAbs + expectedIncomeFeeValue
		assertEq(int256(_daiMockedToken.balanceOf(_userTwo)), 10*10**6*Constants.D18_INT + 0 - openerUserLost); // USER_SUPPLY_10MLN_18_DEC + openerUserEarned - openerUserLost
		assertEq(int256(_daiMockedToken.balanceOf(_userThree)), 10*10**6*Constants.D18_INT + 20*Constants.D18_INT - 0); // USER_SUPPLY_10MLN_18_DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - closerUserLost
		assertEq(balance.totalCollateralReceiveFixed, 0); 
		assertEq(balance.iporPublicationFee, 10*Constants.D18);
		...
		assertEq(28000*Constants.D18 + 10*10**6*Constants.D18 + 10*10**6*Constants.D18, _daiMockedToken.balanceOf(address(mockCase3MiltonDai))  + _daiMockedToken.balanceOf(_userTwo) + _daiMockedToken.balanceOf(_userThree)); // expectedSumOfBalancesBeforePayout(miltonBalanceBeforePayout + openerUserUnderlyingTokenBalanceBeforePayout + closeUserUnderlyingTokenBalanceBeforePayout) vs actualSumOfBalancesBeforePayout(openerUserUnderlyingTokenBalanceBeforePayout + closeUserUnderlyingTokenBalanceAfterPayout + closerUserUnderlyingTokenBalanceAfterPayout + miltonUnderlyingTokenBalanceAfterPayout)
		assertEq(soap, 0);
	}

	function testShouldCalculateIncomeFeeOneHundredPercentWhenPayFixedAndMiltonLosesAndUserEarnsAndDepositIsLowerThanDifferenceBetweenLegsBeforeMaturity() public {
		// given
		_miltonSpreadModel.setCalculateQuotePayFixed(6*10**16);
		ItfIporOracle iporOracle = getIporOracleOneAsset(_admin, _userOne, address(_daiMockedToken), 5*10**16); 
		MockCase1Stanley stanleyDai = getMockCase1Stanley(address(_daiMockedToken));
		...
		vm.prank(_liquidityProvider);
		mockCase0JosephDai.itfProvideLiquidity(28000*Constants.D18, block.timestamp); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC
		openSwapPayFixed(_userTwo, block.timestamp, 10000*Constants.D18, 6*10**16, 10*Constants.D18, mockCase3MiltonDai);
		vm.prank(_userOne);
		iporOracle.itfUpdateIndex(address(_daiMockedToken), 160*10**16, block.timestamp); // PERCENTAGE_160_18DEC
		int256 openerUserLost = 2990102969109267220 + 10*Constants.D18_INT + 20*Constants.D18_INT - 9967009897030890732780 + 9967009897030890732780; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - expectedPayoffAbs + expectedIncomeFeeValue
		// when
		vm.prank(_userTwo); // openerUser
		int256 actualPayoff = mockCase3MiltonDai.itfCalculateSwapPayFixedValue(block.timestamp + 2160000, 1);
		vm.prank(_userThree); // closerUser
		mockCase3MiltonDai.itfCloseSwapPayFixed(1, block.timestamp + 2160000);
		vm.prank(_userThree); // closerUser
		uint256 actualIncomeFeeValue = mockCase3MiltonDai.itfCalculateIncomeFeeValue(actualPayoff);
		// then
		vm.prank(address(miltonStorageDaiProxy));
		...
		vm.prank(address(miltonStorageDaiProxy));
		(, IporTypes.IporSwapMemory[] memory swaps) = miltonStorageDai.getSwapsPayFixed(_userTwo, 0, 50);
        (,, int256 soap) =  calculateSoap(_userTwo, block.timestamp + 2160000, mockCase3MiltonDai);
		assertEq(0, swaps.length);
		assertEq(actualPayoff, 9967009897030890732780); // expectedPayoff
		assertEq(actualIncomeFeeValue, 9967009897030890732780); // expectedIncomeFeeValue
		assertEq(_daiMockedToken.balanceOf(address(mockCase3MiltonDai)), 28000*Constants.D18 + 2990102969109267220 + 10*Constants.D18 - 9967009897030890732780 + 9967009897030890732780); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC - expectedPayoffAbs + expectedIncomeFeeValue
		assertEq(int256(_daiMockedToken.balanceOf(_userTwo)), 10*10**6*Constants.D18_INT + 0 - openerUserLost); // USER_SUPPLY_10MLN_18_DEC + openerUserEarned - openerUserLost
		assertEq(int256(_daiMockedToken.balanceOf(_userThree)), 10*10**6*Constants.D18_INT + 20*Constants.D18_INT - 0); // USER_SUPPLY_10MLN_18_DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - closerUserLost
		assertEq(balance.totalCollateralPayFixed, 0); 
		assertEq(balance.iporPublicationFee, 10*Constants.D18);
	...
	function testShouldCalculateIncomeFeeOneHundredPercentWhenPayFixedAndMiltonEarnsAndUserLosesAndDepositIsGreaterThanDifferenceBetweenLegsBeforeMaturity() public {
		// given
		_miltonSpreadModel.setCalculateQuotePayFixed(121*10**16);
		ItfIporOracle iporOracle = getIporOracleOneAsset(_admin, _userOne, address(_daiMockedToken), 120*10**16); 
		MockCase1Stanley stanleyDai = getMockCase1Stanley(address(_daiMockedToken));
		...
		vm.prank(_liquidityProvider);
		mockCase0JosephDai.itfProvideLiquidity(28000*Constants.D18, block.timestamp); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC
		openSwapPayFixed(_userTwo, block.timestamp, 10000*Constants.D18, 121*10**16, 10*Constants.D18, mockCase3MiltonDai);
		vm.prank(_userOne);
		iporOracle.itfUpdateIndex(address(_daiMockedToken), 5*10**16, block.timestamp); // PERCENTAGE_5_18DEC
		int256 openerUserLost = 2990102969109267220 + 10*Constants.D18_INT + 20*Constants.D18_INT + 7918994164764269383465; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - expectedPayoffAbs 
		// when
		...
		assertEq(_daiMockedToken.balanceOf(address(mockCase3MiltonDai)), 28000*Constants.D18 + 2990102969109267220 + 10*Constants.D18 + 7918994164764269383465); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + expectedPayoffAbs
		assertEq(int256(_daiMockedToken.balanceOf(_userTwo)), 10*10**6*Constants.D18_INT + 20*Constants.D18_INT - openerUserLost); // USER_SUPPLY_10MLN_18_DEC + openerUserEarned - openerUserLost
		assertEq(balance.totalCollateralPayFixed, 0); 
		assertEq(balance.iporPublicationFee, 10*Constants.D18);
		assertEq(balance.liquidityPool, 28000*Constants.D18 + 2990102969109267220 +  7918994164764269383465 - 7918994164764269383465); // miltonBalanceBeforePayoutWad + TC_OPENING_FEE_18DEC + expectedPayoffAbs - expectedIncomeFeeValue
		assertEq(balance.treasury, 7918994164764269383465);
		assertEq(28000*Constants.D18 +  10*10**6*Constants.D18, _daiMockedToken.balanceOf(address(mockCase3MiltonDai)) + _daiMockedToken.balanceOf(_userTwo)); // expectedSumOfBalancesBeforePayout(miltonBalanceBeforePayout + openerUserUnderlyingTokenBalanceBeforePayout + closeUserUnderlyingTokenBalanceBeforePayout) vs actualSumOfBalancesBeforePayout(openerUserUnderlyingTokenBalanceBeforePayout + closeUserUnderlyingTokenBalanceAfterPayout + closerUserUnderlyingTokenBalanceAfterPayout + miltonUnderlyingTokenBalanceAfterPayout)
		assertEq(soap, 0);
	}

	function testShouldCalculateIncomeFeeOneHundredPercentWhenReceiveFixedAndMiltonEarnsAndUserLosesAndDepositIsLowerThanDifferenceBetweenLegsAfterMaturity() public {
		// given
		_miltonSpreadModel.setCalculateQuoteReceiveFixed(4*10**16);
		ItfIporOracle iporOracle = getIporOracleOneAsset(_admin, _userOne, address(_daiMockedToken), 5*10**16); 
		MockCase1Stanley stanleyDai = getMockCase1Stanley(address(_daiMockedToken));
		...
		vm.prank(_liquidityProvider);
		mockCase0JosephDai.itfProvideLiquidity(28000*Constants.D18, block.timestamp); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC
		openSwapReceiveFixed(_userTwo, block.timestamp, 10000*Constants.D18, 4*10**16, 10*Constants.D18, mockCase3MiltonDai);
		vm.prank(_userOne);
		iporOracle.itfUpdateIndex(address(_daiMockedToken), 160*10**16, block.timestamp); // PERCENTAGE_160_18DEC
		int256 openerUserLost = 2990102969109267220 + 10*Constants.D18_INT + 20*Constants.D18_INT + 9967009897030890732780; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - expectedPayoffAbs 
		// when
		...
		assertEq(actualPayoff, -9967009897030890732780); // expectedPayoff
		assertEq(actualIncomeFeeValue, 9967009897030890732780); // expectedIncomeFeeValue
		assertEq(_daiMockedToken.balanceOf(address(mockCase3MiltonDai)), 28000*Constants.D18 + 2990102969109267220 + 10*Constants.D18 + 9967009897030890732780); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + expectedPayoffAbs
		assertEq(int256(_daiMockedToken.balanceOf(_userTwo)), 10*10**6*Constants.D18_INT + 20*Constants.D18_INT - openerUserLost); // USER_SUPPLY_10MLN_18_DEC + openerUserEarned - openerUserLost
		assertEq(balance.totalCollateralPayFixed, 0); 
		assertEq(balance.iporPublicationFee, 10*Constants.D18);
		assertEq(balance.liquidityPool, 28000*Constants.D18 + 2990102969109267220 +  9967009897030890732780 - 9967009897030890732780); // miltonBalanceBeforePayoutWad + TC_OPENING_FEE_18DEC + expectedPayoffAbs - expectedIncomeFeeValue
		assertEq(balance.treasury, 9967009897030890732780);
		assertEq(28000*Constants.D18 + 10*10**6*Constants.D18 + 10*10**6*Constants.D18, _daiMockedToken.balanceOf(address(mockCase3MiltonDai))  + _daiMockedToken.balanceOf(_userTwo) + _daiMockedToken.balanceOf(_userThree)); // expectedSumOfBalancesBeforePayout(miltonBalanceBeforePayout + openerUserUnderlyingTokenBalanceBeforePayout + closeUserUnderlyingTokenBalanceBeforePayout) vs actualSumOfBalancesBeforePayout(openerUserUnderlyingTokenBalanceBeforePayout + closeUserUnderlyingTokenBalanceAfterPayout + closerUserUnderlyingTokenBalanceAfterPayout + miltonUnderlyingTokenBalanceAfterPayout)
		assertEq(soap, 0);
	}
