...
contract MiltonFacadeDataProviderTest is Test, TestCommons, MiltonUtils, MiltonStorageUtils, JosephUtils, IporOracleUtils, DataUtils, SwapUtils, StanleyUtils {
	...
	function testShouldListCorrectNumberItemsUsdtUsdcDai() public {
		...
		vm.prank(_userTwo);
		(uint256 totalCountUsdt, MiltonFacadeTypes.IporSwap[] memory swapsUsdt) = miltonFacadeDataProvider.getMySwaps(address(_usdtMockedToken), 0, 50);
		vm.prank(_userTwo);
		(uint256 totalCountUsdc, MiltonFacadeTypes.IporSwap[] memory swapsUsdc) = miltonFacadeDataProvider.getMySwaps(address(_usdcMockedToken), 0, 50);
		vm.prank(_userTwo);
		(uint256 totalCountDai, MiltonFacadeTypes.IporSwap[] memory swapsDai) = miltonFacadeDataProvider.getMySwaps(address(_daiMockedToken), 0, 50);
		// then
	...
	function testShouldFailWhenPageSizeIsZero() public {
		...
		(uint256 totalCountUsdt, MiltonFacadeTypes.IporSwap[] memory swapsUsdt) = miltonFacadeDataProvider.getMySwaps(address(_usdtMockedToken), 0, 0);
		vm.prank(_userTwo);
		vm.expectRevert(abi.encodePacked("IPOR_009"));
		(uint256 totalCountUsdc, MiltonFacadeTypes.IporSwap[] memory swapsUsdc) = miltonFacadeDataProvider.getMySwaps(address(_usdcMockedToken), 0, 0);
		vm.prank(_userTwo);
		vm.expectRevert(abi.encodePacked("IPOR_009"));
		(uint256 totalCountDai, MiltonFacadeTypes.IporSwap[] memory swapsDai) = miltonFacadeDataProvider.getMySwaps(address(_daiMockedToken), 0, 0);
		// then
	...
	function testShouldFailWhenPageSizeIsGreaterThanFifty() public {
		...
		(uint256 totalCountUsdt, MiltonFacadeTypes.IporSwap[] memory swapsUsdt) = miltonFacadeDataProvider.getMySwaps(address(_usdtMockedToken), 0, 51);
		vm.prank(_userTwo);
		vm.expectRevert(abi.encodePacked("IPOR_010"));
		(uint256 totalCountUsdc, MiltonFacadeTypes.IporSwap[] memory swapsUsdc) = miltonFacadeDataProvider.getMySwaps(address(_usdcMockedToken), 0, 51);
		vm.prank(_userTwo);
		vm.expectRevert(abi.encodePacked("IPOR_010"));
		(uint256 totalCountDai, MiltonFacadeTypes.IporSwap[] memory swapsDai) = miltonFacadeDataProvider.getMySwaps(address(_daiMockedToken), 0, 51);
		// then
		assertEq(totalCountUsdt, 0);
		assertEq(totalCountUsdc, 0);
		assertEq(totalCountDai, 0);
	...
	function testShouldReceiveEmptyListOfSwaps() public {
		...
		vm.prank(_userTwo);
		(uint256 totalCountUsdc, MiltonFacadeTypes.IporSwap[] memory swapsUsdc) = miltonFacadeDataProvider.getMySwaps(address(_usdcMockedToken), 0, 10);
		vm.prank(_userTwo);
		(uint256 totalCountDai, MiltonFacadeTypes.IporSwap[] memory swapsDai) = miltonFacadeDataProvider.getMySwaps(address(_daiMockedToken), 0, 10);
		// then
		assertEq(totalCountUsdt, 0);
		assertEq(totalCountUsdc, 0);
		assertEq(totalCountDai, 0);
	...
	function testShouldReceiveEmptyListOfSwapsWhenUserPassesNonZeroOffsetAndDoesNotHaveAnySwap() public {
		...
		vm.prank(_userTwo);
		(uint256 totalCountUsdc, MiltonFacadeTypes.IporSwap[] memory swapsUsdc) = miltonFacadeDataProvider.getMySwaps(address(_usdcMockedToken), 10, 10);
		vm.prank(_userTwo);
		(uint256 totalCountDai, MiltonFacadeTypes.IporSwap[] memory swapsDai) = miltonFacadeDataProvider.getMySwaps(address(_daiMockedToken), 10, 10);
		// then
		assertEq(totalCountUsdt, 0);
		assertEq(totalCountUsdc, 0);
		assertEq(totalCountDai, 0);
	...
	function testShouldReceiveRestOfSwapsOnly() public {
		...
		vm.prank(_userTwo);
		(uint256 totalCountUsdc, MiltonFacadeTypes.IporSwap[] memory swapsUsdc) = miltonFacadeDataProvider.getMySwaps(address(_usdcMockedToken), 20, 10);
		vm.prank(_userTwo);
		(uint256 totalCountDai, MiltonFacadeTypes.IporSwap[] memory swapsDai) = miltonFacadeDataProvider.getMySwaps(address(_daiMockedToken), 20, 10);
		// then
		assertEq(totalCountUsdt, 22);
		assertEq(totalCountUsdc, 22);
		assertEq(totalCountDai, 22);
