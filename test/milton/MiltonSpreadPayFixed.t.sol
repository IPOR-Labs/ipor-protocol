...
contract MiltonSpreadPayFixedTest is Test, TestCommons {
    ...
    function skiptestShouldCalculateQuoteValuePayFixedSpreadPremiumsPositiveAndBiggerThanIpor()
        public
    {
        //		TODO: fix
        //		// given
    ...
    function skipTestShouldCalculateQuoteValuePayFixedSpreadPremiumsPositive() public {
        ...
        //        // when
        //        vm.prank(_userOne);
        //        uint256 actualQuotedValue = _miltonSpread.calculateQuotePayFixed(
        //            accruedIpor,
        //            accruedBalance
        //        );
        //        // then
