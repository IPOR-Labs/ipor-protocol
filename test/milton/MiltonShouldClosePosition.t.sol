    ...
    StanleyUtils
{
    ...
    function testShouldClosePositionDAIWhenPayFixedMiltonEarnedAndUserLostMoreThanCollateralBeforeMaturity18DecimalsAndSameUserOpensAndCloses(
        ...
        openSwapPayFixed(
            _userTwo, block.timestamp, 10000 * Constants.D18, 161 * 10 ** 16, 10 * Constants.D18, mockCase0MiltonDai
        );
        vm.prank(_userOne);
        iporOracle.itfUpdateIndex(address(_daiMockedToken), 5 * 10 ** 16, block.timestamp); // PERCENTAGE_5_18DEC
        int256 openerUserLost =
            2990102969109267220 + 10 * Constants.D18_INT + 20 * Constants.D18_INT + 9967009897030890732780; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC + expectedPayoffAbs
        // when
        ...
        assertEq(
            ...
            28000 * Constants.D18 + 2990102969109267220 + 10 * Constants.D18 + 9967009897030890732780
        ...
        assertEq(
            ...
            10 * 10 ** 6 * Constants.D18_INT + 20 * Constants.D18_INT - openerUserLost
        ...
        assertEq(
            ...
            28000 * Constants.D18 + 2990102969109267220 + 9967009897030890732780 - 996700989703089073278
        ...
        assertEq(
            28000 * Constants.D18 + 10 * 10 ** 6 * Constants.D18,
    ...
    function testShouldClosePositionDAIWhenPayFixedMiltonEarnedAndUserLostMoreThanCollateralBeforeMaturity18DecimalsAndDifferentUserOpensAndCloses(
        ...
        assertEq(
            int256(_daiMockedToken.balanceOf(_userThree)), 10 * 10 ** 6 * Constants.D18_INT + 20 * Constants.D18_INT - 0
        ); // USER_SUPPLY_10MLN_18_DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - closerUserLost
        assertEq(balance.totalCollateralPayFixed, 0);
        assertEq(balance.iporPublicationFee, 10 * Constants.D18);
        assertEq(
            balance.liquidityPool,
        ...
        assertEq(balance.treasury, 996700989703089073278);
        assertEq(
            28000 * Constants.D18 + 10 * 10 ** 6 * Constants.D18 + 10 * 10 ** 6 * Constants.D18,
            _daiMockedToken.balanceOf(address(mockCase0MiltonDai)) + _daiMockedToken.balanceOf(_userTwo)
    ...
    function testShouldClosePositionUSDTWhenPayFixedMiltonEarnedAndUserLostMoreThanCollateralBeforeMaturity6DecimalsAndSameUserOpensAndCloses(
        ...
        openSwapPayFixed(
            _userTwo, block.timestamp, 10000 * 10 ** 6, 400 * 10 ** 16, 10 * Constants.D18, mockCase0MiltonUsdt
        );
        vm.prank(_userOne);
        ...
        assertEq(
            ...
            28000 * 10 ** 6 + 2990103 + 10 * 10 ** 6 + 9967009897
    ...
    function testShouldClosePositionUSDTWhenPayFixedMiltonEarnedAndUserLostMoreThanCollateralBeforeMaturity6DecimalsAndDifferentUserOpensAndCloses(
        ...
        assertEq(balance.treasury, 996700989703089073278); // expectedIncomeFeeValueWad
        assertEq(
            28000 * 10 ** 6 + 10000000 * 10 ** 6 + 10000000 * 10 ** 6,
            _usdtMockedToken.balanceOf(address(mockCase0MiltonUsdt)) + _usdtMockedToken.balanceOf(_userTwo)
    ...
    function testShouldClosePositionDAIWhenPayFixedMiltonEarnedAndUserLostLessThanCollateralBeforeMaturity18DecimalsAndSameUserOpensAndCloses(
        ...
        mockCase0JosephDai.itfProvideLiquidity(28000 * Constants.D18, block.timestamp); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC
        openSwapPayFixed(
            _userTwo, block.timestamp, 10000 * Constants.D18, 121 * 10 ** 16, 10 * Constants.D18, mockCase0MiltonDai
        );
        vm.prank(_userOne);
        iporOracle.itfUpdateIndex(address(_daiMockedToken), 5 * 10 ** 16, block.timestamp); // PERCENTAGE_5_18DEC
        int256 openerUserLost =
            2990102969109267220 + 10 * Constants.D18_INT + 20 * Constants.D18_INT + 7918994164764269383465; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC + expectedPayoffAbs
        // when
        vm.prank(_userTwo); // openerUser
        int256 actualPayoff = mockCase0MiltonDai.itfCalculateSwapPayFixedValue(block.timestamp + 2160000, 1);
        vm.prank(_userTwo); // closerUser
        ...
        assertEq(
            _daiMockedToken.balanceOf(address(mockCase0MiltonDai)),
            28000 * Constants.D18 + 2990102969109267220 + 10 * Constants.D18 + 7918994164764269383465
        ); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + expectedPayoffAbs
        assertEq(
            int256(_daiMockedToken.balanceOf(_userTwo)),
            10 * 10 ** 6 * Constants.D18_INT + 20 * Constants.D18_INT - openerUserLost
        ...
        assertEq(
            balance.liquidityPool,
            28000 * Constants.D18 + 2990102969109267220 + 7918994164764269383465 - 791899416476426938347
    ...
    function testShouldClosePositionUSDTWhenPayFixedMiltonEarnedAndUserLostLessThanCollateralBeforeMaturity6DecimalsAndSameUserOpensAndCloses(
        ...
        mockCase0JosephUsdt.itfProvideLiquidity(28000 * 10 ** 6, block.timestamp); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC
        openSwapPayFixed(
            _userTwo, block.timestamp, 10000 * 10 ** 6, 10 * 10 ** 16, 10 * Constants.D18, mockCase0MiltonUsdt
        );
        vm.prank(_userOne);
        ...
        assertEq(
            _usdtMockedToken.balanceOf(address(mockCase0MiltonUsdt)),
            28000 * 10 ** 6 + 2990103 + 10 * 10 ** 6 + 341335955
        ); // TC_LP_BALANCE_BEFORE_CLOSE_6DEC + TC_OPENING_FEE_6DEC + TC_IPOR_PUBLICATION_AMOUNT_6DEC + expectedPayoffAbs
        assertEq(int256(_usdtMockedToken.balanceOf(_userTwo)), 10000000 * 10 ** 6 + 20 * 10 ** 6 - openerUserLost); // USER_SUPPLY_10MLN_18_DEC + openerUserEarned - openerUserLost
        assertEq(balance.totalCollateralPayFixed, 0);
        assertEq(balance.iporPublicationFee, 10 * Constants.D18);
        assertEq(
            balance.liquidityPool,
            28000 * Constants.D18 + 2990102969109267220 + 341335955377770264707 - 34133595537777026471
        ); // TC_LP_BALANCE_BEFORE_CLOSE_6DEC + TC_OPENING_FEE_18DEC + expectedPayoffWadAbs - expectedIncomeFeeValueWad
    ...
    function testShouldClosePositionDAIWhenPayFixedMiltonEarnedAndUserLostLessThanCollateralAfterMaturity18DecimalsAndSameUserOpensAndCloses(
        ...
        iporOracle.itfUpdateIndex(address(_daiMockedToken), 5 * 10 ** 16, block.timestamp); // PERCENTAGE_5_18DEC
        int256 openerUserLost =
            2990102969109267220 + 10 * Constants.D18_INT + 20 * Constants.D18_INT + 682671910755540429745; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC + expectedPayoffAbs
        // when
        vm.prank(_userTwo); // openerUser
        ...
        assertEq(
            _daiMockedToken.balanceOf(address(mockCase0MiltonDai)),
            28000 * Constants.D18 + 2990102969109267220 + 10 * Constants.D18 + 682671910755540429745
        ); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + expectedPayoffAbs
        assertEq(
            int256(_daiMockedToken.balanceOf(_userTwo)),
            10 * 10 ** 6 * Constants.D18_INT + 20 * Constants.D18_INT - openerUserLost
        ...
        assertEq(
            balance.liquidityPool,
            28000 * Constants.D18 + 2990102969109267220 + 682671910755540429745 - 68267191075554042975
        ); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE + expectedPayoffWadAbs - expectedIncomeFeeValueWad
    ...
    function testShouldClosePositionDAIWhenPayFixedMiltonLostAndUserEarnedMoreThanCollateralBeforeMaturity18DecimalsAndSameUserOpensAndCloses(
        ...
        mockCase0JosephDai.itfProvideLiquidity(28000 * Constants.D18, block.timestamp); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC
        openSwapPayFixed(
            _userTwo, block.timestamp, 10000 * Constants.D18, 1 * 10 ** 16, 10 * Constants.D18, mockCase0MiltonDai
        );
        vm.prank(_userOne);
        iporOracle.itfUpdateIndex(address(_daiMockedToken), 160 * 10 ** 16, block.timestamp); // PERCENTAGE_160_18DEC
        int256 openerUserLost = 2990102969109267220 + 10 * Constants.D18_INT + 20 * Constants.D18_INT
            - 9967009897030890732780 + 996700989703089073278; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - expectedPayoffAbs + expectedIncomeFeeValue
        // when
        vm.prank(_userTwo); // openerUser
        int256 actualPayoff = mockCase0MiltonDai.itfCalculateSwapPayFixedValue(block.timestamp + 2160000, 1);
        vm.prank(_userTwo); // closerUser
    ...
    function testShouldClosePositionUSDTWhenPayFixedMiltonLostAndUserEarnedMoreThanCollateralBeforeMaturity6DecimalsAndSameUserOpensAndCloses(
        ...
        assertEq(
            _usdtMockedToken.balanceOf(address(mockCase0MiltonUsdt)),
            28000 * 10 ** 6 + 2990103 + 10 * 10 ** 6 - 9967009897 + 996700990
    ...
    function testShouldClosePositionDAIWhenPayFixedMiltonLostAndUserEarnedLessThanCollateralBeforeMaturity18DecimalsAndSameUserOpensAndCloses(
        ...
        mockCase0JosephDai.itfProvideLiquidity(28000 * Constants.D18, block.timestamp); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC
        openSwapPayFixed(
            _userTwo, block.timestamp, 10000 * Constants.D18, 6 * 10 ** 16, 10 * Constants.D18, mockCase0MiltonDai
        );
        vm.prank(_userOne);
        iporOracle.itfUpdateIndex(address(_daiMockedToken), 120 * 10 ** 16, block.timestamp); // PERCENTAGE_120_18DEC
        int256 openerUserLost = 2990102969109267220 + 10 * Constants.D18_INT + 20 * Constants.D18_INT
            - 7782459782613161235257 + 778245978261316123526; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - expectedPayoffAbs + expectedIncomeFeeValue
        // when
        vm.prank(_userTwo); // openerUser
        int256 actualPayoff = mockCase0MiltonDai.itfCalculateSwapPayFixedValue(block.timestamp + 2160000, 1);
        vm.prank(_userTwo); // closerUser
        ...
        assertEq(
            _daiMockedToken.balanceOf(address(mockCase0MiltonDai)),
            28000 * Constants.D18 + 2990102969109267220 + 10 * Constants.D18 - 7782459782613161235257
    ...
    function testShouldClosePositionUSDTWhenPayFixedMiltonLostAndUserEarnedLessThanCollateralBeforeMaturity6DecimalsAndSameUserOpensAndCloses(
        ...
        assertEq(
            _usdtMockedToken.balanceOf(address(mockCase0MiltonUsdt)),
            28000 * 10 ** 6 + 2990103 + 10 * 10 ** 6 - 204801573 + 20480157
        ); // TC_LP_BALANCE_BEFORE_CLOSE_6DEC + TC_OPENING_FEE_6DEC + TC_IPOR_PUBLICATION_AMOUNT_6DEC - expectedPayoffAbs + expectedIncomeFeeValue
        assertEq(int256(_usdtMockedToken.balanceOf(_userTwo)), 10000000 * 10 ** 6 + 20 * 10 ** 6 - openerUserLost); // USER_SUPPLY_10MLN_18_DEC + openerUserEarned - openerUserLost
        assertEq(balance.totalCollateralPayFixed, 0);
        assertEq(balance.iporPublicationFee, 10 * Constants.D18);
    ...
    function testShouldClosePositionDAIWhenPayFixedMiltonLostAndUserEarnedLessThanCollateralAfterMaturity18DecimalsAndSameUserOpensAndCloses(
        ...
        int256 openerUserLost = 2990102969109267220 + 10 * Constants.D18_INT + 20 * Constants.D18_INT
            - 6007512814648756073133 + 600751281464875607313; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - expectedPayoffAbs + expectedIncomeFeeValue
        // when
        vm.prank(_userTwo); // openerUser
        int256 actualPayoff = mockCase0MiltonDai.itfCalculateSwapPayFixedValue(block.timestamp + 4320000, 1);
        vm.prank(_userTwo); // closerUser
        ...
        assertEq(
            _daiMockedToken.balanceOf(address(mockCase0MiltonDai)),
            28000 * Constants.D18 + 2990102969109267220 + 10 * Constants.D18 - 6007512814648756073133
    ...
    function testShouldClosePositionDAIWhenPayFixedMiltonLostAndUserEarnedBetween99And100PercentOfCollateralAfterBeforeMaturity18DecimalsAndDifferentUserOpensAndCloses(
        ...
        int256 openerUserLost = 2990102969109267220 + 10 * Constants.D18_INT + 20 * Constants.D18_INT
            - 9898742705955336652531 + 989874270595533665253; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - expectedPayoffAbs + expectedIncomeFeeValue
        // when
        vm.prank(_userTwo); // openerUser
        int256 actualPayoff = mockCase0MiltonDai.itfCalculateSwapPayFixedValue(block.timestamp + 2160000, 1);
        vm.prank(_userThree); // closerUser
        ...
        assertEq(
            _daiMockedToken.balanceOf(address(mockCase0MiltonDai)),
            28000 * Constants.D18 + 2990102969109267220 + 10 * Constants.D18 - 9898742705955336652531
    ...
    function testShouldClosePositionDAIWhenPayFixedMiltonEarnedAndUserLostBetween99And100PercentOfCollateralBeforeMaturity18DecimalsAndDifferentUserOpensAndCloses(
        ...
        mockCase0JosephDai.itfProvideLiquidity(28000 * Constants.D18, block.timestamp); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC
        openSwapPayFixed(
            _userTwo, block.timestamp, 10000 * Constants.D18, 151 * 10 ** 16, 10 * Constants.D18, mockCase0MiltonDai
        );
        vm.prank(_userOne);
        iporOracle.itfUpdateIndex(address(_daiMockedToken), 6 * 10 ** 16, block.timestamp); // PERCENTAGE_6_18DEC
        int256 openerUserLost =
            2990102969109267220 + 10 * Constants.D18_INT + 20 * Constants.D18_INT + 9898742705955336727624; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - expectedPayoffAbs
        // when
        vm.prank(_userTwo); // openerUser
        int256 actualPayoff = mockCase0MiltonDai.itfCalculateSwapPayFixedValue(block.timestamp + 2160000, 1);
        vm.prank(_userThree); // closerUser
        ...
        assertEq(
            _daiMockedToken.balanceOf(address(mockCase0MiltonDai)),
            28000 * Constants.D18 + 2990102969109267220 + 10 * Constants.D18 + 9898742705955336727624
        ); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + expectedPayoffAbs
        assertEq(int256(_daiMockedToken.balanceOf(_userTwo)), 10 * 10 ** 6 * Constants.D18_INT + 0 - openerUserLost); // USER_SUPPLY_10MLN_18_DEC + openerUserEarned - openerUserLost
        assertEq(
            int256(_daiMockedToken.balanceOf(_userThree)), 10 * 10 ** 6 * Constants.D18_INT + 20 * Constants.D18_INT - 0
        ...
        assertEq(
            balance.liquidityPool,
            28000 * Constants.D18 + 2990102969109267220 + 9898742705955336727624 - 989874270595533672762
        ); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE + expectedPayoffWadAbs - expectedIncomeFeeValueWad
    ...
    function testShouldClosePositionDAIWhenPayFixedMiltonEarnedAndUserLostLessThanCollateralFiveHoursBeforeMaturity18DecimalsAndDifferentUserOpensAndCloses(
        ...
        iporOracle.itfUpdateIndex(address(_daiMockedToken), 5 * 10 ** 16, block.timestamp); // PERCENTAGE_5_18DEC
        int256 openerUserLost =
            2990102969109267220 + 10 * Constants.D18_INT + 20 * Constants.D18_INT + 8803281846496279452160; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC + expectedPayoffAbs
        // when
        vm.prank(_userTwo); // openerUser
        ...
        assertEq(
            _daiMockedToken.balanceOf(address(mockCase0MiltonDai)),
            28000 * Constants.D18 + 2990102969109267220 + 10 * Constants.D18 + 8803281846496279452160
        ); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC - expectedPayoffAbs
        assertEq(int256(_daiMockedToken.balanceOf(_userTwo)), 10 * 10 ** 6 * Constants.D18_INT + 0 - openerUserLost); // USER_SUPPLY_10MLN_18_DEC + openerUserEarned - openerUserLost
        assertEq(
            int256(_daiMockedToken.balanceOf(_userThree)), 10 * 10 ** 6 * Constants.D18_INT + 20 * Constants.D18_INT - 0
        ...
        assertEq(
            balance.liquidityPool,
            28000 * Constants.D18 + 2990102969109267220 + 8803281846496279452160 - 880328184649627945216
        ); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE + expectedPayoffWadAbs - expectedIncomeFeeValueWad
    ...
    function testShouldClosePositionDAIWhenReceiveFixedMiltonLostAndUserEarnedLessThanCollateralFiveHoursBeforeMaturity18DecimalsAndDifferentUserOpensAndCloses(
        ...
        openSwapReceiveFixed(
            _userTwo, block.timestamp, 10000 * Constants.D18, 10 * 10 ** 16, 10 * Constants.D18, mockCase0MiltonDai
        );
        vm.prank(_userOne);
        iporOracle.itfUpdateIndex(address(_daiMockedToken), 5 * 10 ** 16, block.timestamp); // PERCENTAGE_5_18DEC
        int256 openerUserLost = 2990102969109267220 + 10 * Constants.D18_INT + 20 * Constants.D18_INT
            - 379451803728287931809 + 37945180372828793181; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC - expectedPayoffAbs + expectedIncomeFeeValue
        // when
        vm.prank(_userTwo); // openerUser
        ...
        assertEq(
            _daiMockedToken.balanceOf(address(mockCase0MiltonDai)),
            28000 * Constants.D18 + 2990102969109267220 + 10 * Constants.D18 - 379451803728287931809
    ...
    function testShouldClosePositionDAIWhenReceiveFixedMiltonLostAndUserEarnedMoreThanCollateralBeforeMaturity18DecimalsAndSameUserOpensAndCloses(
        ...
        mockCase0JosephDai.itfProvideLiquidity(28000 * Constants.D18, block.timestamp); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC
        openSwapReceiveFixed(
            _userTwo, block.timestamp, 10000 * Constants.D18, 159 * 10 ** 16, 10 * Constants.D18, mockCase0MiltonDai
        );
        vm.prank(_userOne);
        iporOracle.itfUpdateIndex(address(_daiMockedToken), 5 * 10 ** 16, block.timestamp); // PERCENTAGE_5_18DEC
        int256 openerUserLost = 2990102969109267220 + 10 * Constants.D18_INT + 20 * Constants.D18_INT
    ...
    function testShouldClosePositionDAIWhenReceiveFixedMiltonEarnedAndUserLostLessThanCollateralBeforeMaturity18DecimalsAndSameUserOpensAndClosesAndIpor6Percent(
        ...
        iporOracle.itfUpdateIndex(address(_daiMockedToken), 6 * 10 ** 16, block.timestamp); // PERCENTAGE_6_18DEC
        int256 openerUserLost =
            2990102969109267220 + 10 * Constants.D18_INT + 20 * Constants.D18_INT + 341335955377770189613; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC + expectedPayoffAbs
        // when
        vm.prank(_userTwo); // openerUser
        int256 actualPayoff = mockCase0MiltonDai.itfCalculateSwapReceiveFixedValue(block.timestamp + 2160000, 1);
        vm.prank(_userTwo); // closerUser
        ...
        assertEq(
            _daiMockedToken.balanceOf(address(mockCase0MiltonDai)),
            28000 * Constants.D18 + 2990102969109267220 + 10 * Constants.D18 + 341335955377770189613
        ); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + expectedPayoffAbs
        assertEq(
            int256(_daiMockedToken.balanceOf(_userTwo)),
            10 * 10 ** 6 * Constants.D18_INT + 20 * Constants.D18_INT - openerUserLost
        ...
        assertEq(
            balance.liquidityPool,
            28000 * Constants.D18 + 2990102969109267220 + 341335955377770189613 - 34133595537777018961
        ); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE + expectedPayoffWadAbs - expectedIncomeFeeValueWad
    ...
    function testShouldClosePositionDAIWhenReceiveFixedMiltonEarnedAndUserLostMoreThanCollateralBeforeMaturity18DecimalsAndSameUserOpensAndClosesAndIpor160Percent(
        ...
        mockCase0JosephDai.itfProvideLiquidity(28000 * Constants.D18, block.timestamp); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC
        openSwapReceiveFixed(
            _userTwo, block.timestamp, 10000 * Constants.D18, 4 * 10 ** 16, 10 * Constants.D18, mockCase0MiltonDai
        );
        vm.prank(_userOne);
        iporOracle.itfUpdateIndex(address(_daiMockedToken), 160 * 10 ** 16, block.timestamp); // PERCENTAGE_160_18DEC
        int256 openerUserLost =
    ...
    function testShouldClosePositionDAIWhenReceiveFixedMiltonEarnedAndUserLostLessThanCollateralBeforeMaturity18DecimalsAndSameUserOpensAndClosesAndIpor120Percent(
        ...
        iporOracle.itfUpdateIndex(address(_daiMockedToken), 120 * 10 ** 16, block.timestamp); // PERCENTAGE_120_18DEC
        int256 openerUserLost =
            2990102969109267220 + 10 * Constants.D18_INT + 20 * Constants.D18_INT + 7918994164764269327486; // TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + TC_LIQUIDATION_DEPOSIT_AMOUNT_18DEC + expectedPayoffAbs
        // when
        vm.prank(_userTwo); // openerUser
        int256 actualPayoff = mockCase0MiltonDai.itfCalculateSwapReceiveFixedValue(block.timestamp + 2160000, 1);
        vm.prank(_userTwo); // closerUser
        ...
        assertEq(
            _daiMockedToken.balanceOf(address(mockCase0MiltonDai)),
            28000 * Constants.D18 + 2990102969109267220 + 10 * Constants.D18 + 7918994164764269327486
        ); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE_18DEC + TC_IPOR_PUBLICATION_AMOUNT_18DEC + expectedPayoffAbs
        assertEq(
            int256(_daiMockedToken.balanceOf(_userTwo)),
            10 * 10 ** 6 * Constants.D18_INT + 20 * Constants.D18_INT - openerUserLost
        ...
        assertEq(
            balance.liquidityPool,
            28000 * Constants.D18 + 2990102969109267220 + 7918994164764269327486 - 791899416476426932749
        ); // TC_LP_BALANCE_BEFORE_CLOSE_18DEC + TC_OPENING_FEE + expectedPayoffWadAbs - expectedIncomeFeeValueWad
