...
contract('IporAmm', (accounts) => {
    ...
    //     //TODO: dodaj pozycję long i potem zdejmij pozycję - sprawdz czy soap = 0;
    // });
    //
    // it('should calculate soap, DAI, rec fixed, add and remove position', async () => {
    //     //TODO: dodaj pozycję short i potem zdejmij pozycję - sprawdz czy soap = 0;
    // });
    //
    // it('should calculate soap, DAI add pay fixed, DAI add rec fixed', async () => {
    //     //TODO: add long and short position of the same assets and verify soap
    // });
    //
    // it('should calculate soap, DAI add pay fixed, USDC add pay fixed', async () => {
    //     //TODO: add long and short position of different assets and verify soap
    // });
    //
    // it('should calculate soap, DAI add pay fixed, DAI add rec fixed, remove rec fixed position', async () => {
    //     //TODO: dodaj 2 pozycje i zejmij jedna - sprawdz czy soap jest ok
    // });
    //
    // it('should calculate soap, DAI add pay fixed, DAI add rec fixed, remove pay fixed position', async () => {
    //     //TODO: dodaj 2 pozycje i zejmij jedna - sprawdz czy soap jest ok
    // });
    //
    // it('should calculate soap, DAI add pay fixed, USDC add rec fixed, remove DAI rec fixed position', async () => {
    //     //TODO: dodaj 2 pozycje i zejmij jedna - sprawdz czy soap jest ok
    // });
