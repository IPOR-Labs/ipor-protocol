...
contract ArbitrumForkAmmUsdcCloseSwapsTest is ArbitrumTestForkCommons {
    ...
    function testShouldClosePositionWstEthForWstEth28daysPayFixedBeforeMaturityWithoutUnwind() public {
        //given
        _init();
        address user = _getUserAddress(22);
        _setupUser(user, 1000 * 1e18);
    ...
    function testShouldClosePositionWstEthForWstEth60daysPayFixed() public {
        //given
        _init();
        address user = _getUserAddress(22);
        _setupUser(user, 1000 * 1e18);
    ...
    function testShouldClosePositionWstEthForWstEth60daysPayFixedBeforeMaturityWithoutUnwind() public {
        //given
        _init();
        address user = _getUserAddress(22);
        _setupUser(user, 1000 * 1e18);
    ...
    function testShouldClosePositionWstEthForWstEth90daysPayFixed() public {
        //given
        _init();
        address user = _getUserAddress(22);
        _setupUser(user, 1000 * 1e18);
