...
contract("IporAssetConfigurationRoles", (accounts) => {
    ...
    it("should grant and revoke ROLES_INFO_*", async () => {
        ...
        let hasAdminRole = await iporAssetConfigurationDAI.hasRole(
            adminRole,
            userOne
        );
        assert(!hasAdminRole);
        ...
        hasAdminRole = await iporAssetConfigurationDAI.hasRole(
            adminRole,
            userOne
        );
        assert(hasAdminRole);
        ...
        await iporAssetConfigurationDAI.grantRole(role, userTwo, {
            from: userOne,
        });
        ...
        await iporAssetConfigurationDAI.revokeRole(role, userTwo, {
            from: userOne,
        });
    ...
    it("should NOT be able to grant ROLES_INFO_ROLE role", async () => {
        ...
        await testUtils.assertError(
            //when
            iporAssetConfigurationDAI.grantRole(role, userTwo, {
                from: userOne,
            }),
