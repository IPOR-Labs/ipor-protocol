...
library TestConstants {
    ...
    uint64 public constant MSO_NOTIONAL_100K = 10;
    uint64 public constant MSO_NOTIONAL_1M = 100;
    uint64 public constant MSO_NOTIONAL_1M_500K = 150;
    uint64 public constant MSO_NOTIONAL_2M_220K = 222;
    uint64 public constant MSO_NOTIONAL_10M = 1000;
    uint64 public constant MSO_NOTIONAL_50M = 5000;
    uint64 public constant MSO_NOTIONAL_100M = 10000;
    ...
    uint16 public constant MSO_UTILIZATION_RATE_0_1_PER = 10;
    uint16 public constant MSO_UTILIZATION_RATE_5_PER = 500;
