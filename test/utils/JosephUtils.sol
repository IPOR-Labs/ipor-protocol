...
contract JosephUtils is Test {
	...
	function getMockCase0Josephs (
		...
		(mockCase0Josephs.mockCase0JosephUsdtProxy, mockCase0Josephs.mockCase0JosephUsdt) = getMockCase0JosephUsdt(deployer, tokenAddresses[0], ipTokenAddresses[0], miltonAddresses[0], miltonStorageAddresses[0], stanleyAddresses[0]);
		(mockCase0Josephs.mockCase0JosephUsdcProxy, mockCase0Josephs.mockCase0JosephUsdc) = getMockCase0JosephUsdc(deployer, tokenAddresses[1], ipTokenAddresses[1], miltonAddresses[1], miltonStorageAddresses[1], stanleyAddresses[1]);
		(mockCase0Josephs.mockCase0JosephDaiProxy, mockCase0Josephs.mockCase0JosephDai) = getMockCase0JosephDai(deployer, tokenAddresses[2], ipTokenAddresses[2], miltonAddresses[2], miltonStorageAddresses[2], stanleyAddresses[2]);
