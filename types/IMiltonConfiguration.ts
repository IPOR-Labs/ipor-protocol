...
export interface IMiltonConfigurationInterface extends utils.Interface {
  contractName: "IMiltonConfiguration";
  functions: {
...
export interface IMiltonConfiguration extends BaseContract {
  contractName: "IMiltonConfiguration";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMiltonConfigurationInterface;
