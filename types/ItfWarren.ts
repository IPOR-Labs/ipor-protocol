...
export interface ItfWarrenInterface extends utils.Interface {
  contractName: "ItfWarren";
  functions: {
    ...
    "itfGetDecayFactorValue()": FunctionFragment;
    "itfUpdateIndex(address,uint256,uint256)": FunctionFragment;
    "itfUpdateIndexes(address[],uint256[],uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "itfGetDecayFactorValue",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "itfUpdateIndex",
    values: [string, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "itfUpdateIndexes",
    values: [string[], BigNumberish[], BigNumberish]
  ): string;
...
export interface ItfWarren extends BaseContract {
  contractName: "ItfWarren";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ItfWarrenInterface;
  ...
  functions: {
    ...
    itfGetDecayFactorValue(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    "itfUpdateIndex(address,uint256,uint256)"(
      asset: string,
      indexValue: BigNumberish,
      updateTimestamp: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ...
    "itfUpdateIndexes(address[],uint256[],uint256)"(
      assets: string[],
      indexValues: BigNumberish[],
      updateTimestamp: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
