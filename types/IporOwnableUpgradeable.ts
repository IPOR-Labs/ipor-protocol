...
export interface IporOwnableUpgradeableInterface extends utils.Interface {
  contractName: "IporOwnableUpgradeable";
  functions: {
...
export interface IporOwnableUpgradeable extends BaseContract {
  contractName: "IporOwnableUpgradeable";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IporOwnableUpgradeableInterface;
