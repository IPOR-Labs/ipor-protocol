...
export interface IMiltonStorageInterface extends utils.Interface {
  contractName: "IMiltonStorage";
  functions: {
...
export interface IMiltonStorage extends BaseContract {
  contractName: "IMiltonStorage";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMiltonStorageInterface;
