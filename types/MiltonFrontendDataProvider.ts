...
export interface MiltonFrontendDataProviderInterface extends utils.Interface {
  contractName: "MiltonFrontendDataProvider";
  functions: {
...
export interface MiltonFrontendDataProvider extends BaseContract {
  contractName: "MiltonFrontendDataProvider";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MiltonFrontendDataProviderInterface;
