...
export interface IporOwnableInterface extends utils.Interface {
  contractName: "IporOwnable";
  functions: {
...
export interface IporOwnable extends BaseContract {
  contractName: "IporOwnable";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IporOwnableInterface;
