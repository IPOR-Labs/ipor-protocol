...
/// @title Abstract contract for closing swap, generation one, characterized by: with additional asset management logic and rebalance between AmmTreasury and AmmVault (PlasmaVault from Ipor Fusion)
