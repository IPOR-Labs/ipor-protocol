...
abstract contract AmmCloseSwapServiceBaseV2 is IAmmCloseSwapService {
    ...
    uint256 public immutable version = 2_003;
    ...
    constructor(
        ...
        ammVault = poolCfg.assetManagement.checkAddress();
