...
abstract contract AccessControlAssetConfiguration is AccessControlRevoke {
    ...
    bytes32 internal constant _LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ROLE =
        keccak256("LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ROLE");
    bytes32
        internal constant _LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ADMIN_ROLE =
    ...
    constructor(address root) {
        ...
        _setRoleAdmin(
            _LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ADMIN_ROLE,
            _ADMIN_ROLE
        );
        _setRoleAdmin(
            _LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ROLE,
            _LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ADMIN_ROLE
        );
