...
abstract contract AccessControlMiltonSpreadModelConfiguration is AccessControlRevoke {
    ...
    bytes32 internal constant MILTON_SPREAD_MODEL_ROLE =
        keccak256("MILTON_SPREAD_MODEL_ROLE");
    bytes32 internal constant MILTON_SPREAD_MODEL_ADMIN_ROLE =
    ...
    constructor(address root) {
        ...
        _setRoleAdmin(MILTON_SPREAD_MODEL_ADMIN_ROLE, ADMIN_ROLE);
        _setRoleAdmin(
