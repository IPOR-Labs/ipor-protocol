...
abstract contract AccessControlConfiguration is AccessControlRevoke {
    ...
    bytes32 internal constant IPOR_ASSETS_ADMIN_ROLE = keccak256("IPOR_ASSETS_ADMIN_ROLE");

    bytes32 internal constant MILTON_ADMIN_ROLE = keccak256("MILTON_ADMIN_ROLE");
    ...
    bytes32 internal constant WARREN_ADMIN_ROLE = keccak256("WARREN_ADMIN_ROLE");
    ...
    bytes32 internal constant JOSEPH_ADMIN_ROLE = keccak256("JOSEPH_ADMIN_ROLE");
    ...
    constructor(address root) {
        ...
        _setRoleAdmin(MILTON_LP_UTILIZATION_STRATEGY_ROLE, MILTON_LP_UTILIZATION_STRATEGY_ADMIN_ROLE);

        _setRoleAdmin(MILTON_SPREAD_STRATEGY_ADMIN_ROLE, ADMIN_ROLE);
        _setRoleAdmin(MILTON_SPREAD_STRATEGY_ROLE, MILTON_SPREAD_STRATEGY_ADMIN_ROLE);

        _setRoleAdmin(IPOR_ASSET_CONFIGURATION_ADMIN_ROLE, ADMIN_ROLE);
        _setRoleAdmin(IPOR_ASSET_CONFIGURATION_ROLE, IPOR_ASSET_CONFIGURATION_ADMIN_ROLE);
        ...
        _setRoleAdmin(MILTON_PUBLICATION_FEE_TRANSFERER_ROLE, MILTON_PUBLICATION_FEE_TRANSFERER_ADMIN_ROLE);
    }
}
