...
contract aaveLendingPoolCoreMock is AaveLendingPoolCore {
  ...
  function getReserveInterestRateStrategyAddress(address) external override view returns (address) {
    return reserve;
  }
  ...
  function getReserveAvailableLiquidity(address) external override view returns (uint256) {
    return liquidity;
  }
  ...
  function getReserveTotalBorrowsStable(address) external override view returns (uint256) {
  ...
  function getReserveTotalBorrowsVariable(address) external override view returns (uint256) {
  ...
  function getReserveCurrentAverageStableBorrowRate(address) external override view returns (uint256) {
  ...
  function getReserveCurrentLiquidityRate(address) external override view returns (uint256 liquidityRate) {
    return apr;
  }
