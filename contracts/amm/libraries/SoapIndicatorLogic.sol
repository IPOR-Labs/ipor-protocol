...
library SoapIndicatorLogic {
    ...
    function calculateQuasiInterestPaidOut(
        ...
        return
            derivativeNotional * swapFixedInterestRate * (calculateTimestamp - derivativeOpenTimestamp) * Constants.D18;
    }
    ...
    function calculateQuasiHypotheticalInterestDelta(
        ...
        return totalNotional * averageInterestRate * (calculateTimestamp - lastRebalanceTimestamp) * Constants.D18;
    }
