...
contract TestMiltonV1Proxy is MiltonV1 {
    ...
    function test_openPosition(
        ...
        return _openPosition(openTimestamp, stringToBytes32(asset), totalAmount, maximumSlippage, leverage, direction);
    }
    ...
    function test_calculateSoap(
        ...
        return _calculateSoap(stringToBytes32(asset), calculateTimestamp);
    }

    function test_calculateSpread(
        string memory asset,
        uint256 calculateTimestamp) public view returns (uint256 spreadPf, uint256 spreadRf){
        return _calculateSpread(stringToBytes32(asset), calculateTimestamp);
    }
