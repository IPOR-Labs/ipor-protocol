...
contract AmmOpenSwapService is IAmmOpenSwapService {
    ...
    function openSwapPayFixed28daysUsdt(
        ...
        Context memory context = Context({
            ...
            spreadMethodSig: "calculateQuotePayFixed28Days((address,uint256,uint256,uint256,int256,uint256,uint256,uint256,uint256,uint256,uint256,uint256))",
    ...
    function openSwapPayFixed60daysUsdt(
        ...
        Context memory context = Context({
            ...
            spreadMethodSig: "calculateQuotePayFixed60Days((address,uint256,uint256,uint256,int256,uint256,uint256,uint256,uint256,uint256,uint256,uint256))",
            poolCfg: _getPoolConfiguration(_usdt)
        });
        return _openSwapPayFixed(context, totalAmount, acceptableFixedInterestRate, leverage);
    }
    ...
    function openSwapPayFixed90daysUsdt(
        ...
        Context memory context = Context({
            ...
            spreadMethodSig: "calculateQuotePayFixed90Days((address,uint256,uint256,uint256,int256,uint256,uint256,uint256,uint256,uint256,uint256,uint256))",
            poolCfg: _getPoolConfiguration(_usdt)
        });
        return _openSwapPayFixed(context, totalAmount, acceptableFixedInterestRate, leverage);
    }
    ...
    function openSwapReceiveFixed28daysUsdt(
        ...
        Context memory context = Context({
            onBehalfOf: onBehalfOf,
            duration: AmmTypes.SwapDuration.DAYS_28,
            spreadMethodSig: "calculateQuoteReceiveFixed28Days((address,uint256,uint256,uint256,int256,uint256,uint256,uint256,uint256,uint256,uint256,uint256))",
            poolCfg: _getPoolConfiguration(_usdt)
        });
    ...
    function openSwapReceiveFixed60daysUsdt(
        ...
        Context memory context = Context({
            onBehalfOf: onBehalfOf,
            duration: AmmTypes.SwapDuration.DAYS_60,
            spreadMethodSig: "calculateQuoteReceiveFixed60Days((address,uint256,uint256,uint256,int256,uint256,uint256,uint256,uint256,uint256,uint256,uint256))",
            poolCfg: _getPoolConfiguration(_usdt)
        });
        return _openSwapReceiveFixed(context, totalAmount, acceptableFixedInterestRate, leverage);
    }
    ...
    function openSwapReceiveFixed90daysUsdt(
        ...
        Context memory context = Context({
            onBehalfOf: onBehalfOf,
            duration: AmmTypes.SwapDuration.DAYS_90,
            spreadMethodSig: "calculateQuoteReceiveFixed90Days((address,uint256,uint256,uint256,int256,uint256,uint256,uint256,uint256,uint256,uint256,uint256))",
            poolCfg: _getPoolConfiguration(_usdt)
        });
        return _openSwapReceiveFixed(context, totalAmount, acceptableFixedInterestRate, leverage);
    }
