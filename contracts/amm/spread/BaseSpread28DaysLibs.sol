...
library BaseSpread28DaysLibs {
    ...
    function _calculateVolatilityAndMeanReversionPayFixed(
        ...
        int256 regionOne = _volatilityAndMeanReversionPayFixedRegionOne(emaVar, diffIporIndexEma, config);
        int256 regionTwo = _volatilityAndMeanReversionPayFixedRegionTwo(emaVar, diffIporIndexEma, config);
