...
library MiltonErrors {
    ...
    /// @dev SOAP can be negative, Sum of SOAM and Liquidity Pool Balance can be negative, but this is undesirable
    ...
    /// @notice Appears during closing position in batch when all selected swaps are already closed.
    string public constant ALL_SWAPS_ALREADY_CLOSED = "IPOR_329";

    /// @notice Swaps list is empty.
    string public constant SWAPS_LIST_IS_EMPTY = "IPOR_330";
}
