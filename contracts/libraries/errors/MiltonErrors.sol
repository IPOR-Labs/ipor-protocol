...
library MiltonErrors {
    ...
    string public constant COLLATERALIZATION_FACTOR_TOO_LOW = "IPOR_306";

    string public constant COLLATERALIZATION_FACTOR_TOO_HIGH = "IPOR_307";
    ...
    string public constant CANNOT_CLOSE_SWAP_LP_IS_TOO_LOW = "IPOR_319";
    ...
    string public constant SPREAD_EMVAR_CANNOT_BE_HIGHER_THAN_ONE = "IPOR_323";
