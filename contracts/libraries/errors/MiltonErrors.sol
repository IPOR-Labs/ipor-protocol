...
library MiltonErrors {
    ...
    string public constant LP_UTILIZATION_EXCEEDED = "IPOR_301";

    //@notice Liquidity Pool Utilization Per Leg exceeded
    string public constant LP_UTILIZATION_PER_LEG_EXCEEDED = "IPOR_302";

    //@notice Swap id used in input has incorrect value (like 0) or not exists
    string public constant INCORRECT_SWAP_ID = "IPOR_303";
    ...
    string public constant TOTAL_AMOUNT_LOWER_THAN_FEE = "IPOR_308";

    //@notice Amount of collateral used to open swap exceeds limit
    string public constant COLLATERAL_AMOUNT_TOO_HIGH = "IPOR_309";

    //@notice ibtPrice has to be higher than 0
    string public constant IBT_PRICE_CANNOT_BE_ZERO = "IPOR_310";
    ...
    string public constant CANNOT_CLOSE_SWAP_LIQUIDATION_DEPOSIT_BALANCE_IS_TOO_LOW = "IPOR_320";
    ...
    string public constant SPREAD_PREMIUMS_CANNOT_BE_HIGHER_THAN_IPOR_INDEX = "IPOR_324";
    ...
    string public constant CANNOT_REDEEM_LIQUIDITY_POOL_IS_TOO_LOW = "IPOR_327";

    // @notice Milton Vault Balance in Asset Management is lower than last saved vaultBalance in Milton
    string public constant VAULT_BALANCE_TOO_LOW = "IPOR_328";
