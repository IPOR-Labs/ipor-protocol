...
contract AmmSwapsLensEthereum is IAmmSwapsLens {
    ...
    function getSwaps(
        ...
        StorageLibEthereum.AssetLensDataValue storage lensPoolCfg = StorageLibEthereum.getAssetLensDataStorage().value[
            asset
        ];
    ...
    function getOfferedRate(
        ...
        address messageSigner = StorageLibEthereum.getMessageSignerStorage().value;
    ...
    function _getSwapLensPoolConfiguration(address asset_) internal view returns (SwapLensPoolConfiguration memory) {
        StorageLibEthereum.AssetLensDataValue memory lensPoolCfg = StorageLibEthereum.getAssetLensDataStorage().value[
            asset_
        ];
        return
