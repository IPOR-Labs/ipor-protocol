...
library IporErrors {
    ...
    string public constant INCORRECT_IPOR_CONFIGURATION_ADDRESS = "IPOR_003";

    //TODO: add test for this
    //@notice Asset has too low decimals
    string public constant CONFIG_ASSET_DECIMALS_TOO_LOW = "IPOR_004";

    //@notice Max Utilization Rate when Redeem should be higher than Liquidity Pool Max Utilization rate
    string public constant CONFIG_REDEEM_MAX_UTILIZATION_LOWER_THAN_LP_MAX_UTILIZATION = "IPOR_005";

    //@notice Decay factor cannot be higher than 1 * D18
    string public constant CONFIG_DECAY_FACTOR_TOO_HIGH = "IPOR_006";

    //@notice Redeem Max Utilization Rate is too high
    string public constant CONFIG_REDEEM_MAX_UTILIZATION_PERCENTAGE_TOO_HIGH = "IPOR_007";

    //@notice msg.sender is not an appointed owner, so cannot confirm his appointment to be an owner of a specific smart contract
    string public constant SENDER_NOT_APPOINTED_OWNER = "IPOR_101";

    //@notice Amount is too low to transfer
    string public constant NOT_ENOUGH_AMOUNT_TO_TRANSFER = "IPOR_102";
    ...
    string public constant IPOR_PUBLICATION_FEE_BALANCE_TOO_LOW = "IPOR_104";
    ...
    string public constant WARREN_ASSET_NOT_SUPPORTED = "IPOR_204";

    //@notice Updater address is wrong
    string public constant WARREN_WRONG_UPDATER_ADDRESS = "IPOR_205";

    // 300-399-milton
    //@notice The caller must be the Milton smart contract
    string public constant MILTON_CALLER_NOT_MILTON = "IPOR_301";
    ...
    string public constant MILTON_CANNOT_CLOSE_DERIVATE_LIQUIDITY_POOL_IS_TOO_LOW = "IPOR_308";
    ...
    string public constant MILTON_DERIVATIVE_NOTIONAL_HIGHER_THAN_TOTAL_NOTIONAL = "IPOR_310";

    //@notice Swap id used in input has incorrect value (like 0) or not exists
    string public constant MILTON_CLOSE_POSITION_INCORRECT_SWAP_ID = "IPOR_311";

    //@notice Swap has incorrect status
    string public constant MILTON_CLOSE_POSITION_INCORRECT_DERIVATIVE_STATUS = "IPOR_312";
    ...
    string public constant MILTON_CLOSING_TIMESTAMP_LOWER_THAN_DERIVATIVE_OPEN_TIMESTAMP =
        "IPOR_321";
    string public constant MILTON_CALC_TIMESTAMP_HIGHER_THAN_DERIVATIVE_OPEN_TIMESTAMP = "IPOR_322";
    ...
    string public constant IP_TOKEN_MINT_AMOUNT_TOO_LOW = "IPOR_326";

    //@notice Amount which should be burned is too low
    string public constant IP_TOKEN_BURN_AMOUNT_TOO_LOW = "IPOR_327";

    //@notice Trader doesnt have enought tokens to execute transaction
    string public constant MILTON_ASSET_BALANCE_OF_TOO_LOW = "IPOR_328";

    string public constant MILTON_LP_UTILIZATION_EXCEEDED = "IPOR_329";

    //@notice ibtPrice has to be higher than 0
    string public constant MILTON_IBT_PRICE_CANNOT_BE_ZERO = "IPOR_330";

    //@notice Incorrect IPOR Configuration address
    string public constant MILTON_INCORRECT_CONFIGURATION_ADDRESS = "IPOR_331";

    //@notice Cannot add new asset to asset list, because already exists
    string public constant MILTON_CANNOT_ADD_ASSET_ASSET_ALREADY_EXISTS = "IPOR_332";

    //@notice User cannot redeem underlying tokens because ipToken on his balance is too low
    string public constant MILTON_CANNOT_REDEEM_IP_TOKEN_TOO_LOW = "IPOR_333";

    //TODO: try to add test for this
    //@notice Spread value cannot be higher than Ipor Index Value for particular asset
    string public constant MILTON_SPREAD_PREMIUMS_CANNOT_BE_HIGHER_THAN_IPOR_INDEX = "IPOR_334";

    string public constant MILTON_STANLEY_BALANCE_IS_EMPTY = "IPOR_336";

    // 400-499-joseph
    string public constant CALLER_NOT_TREASURE_TRANSFERER = "IPOR_401";

    //@notice Charlie Treasurer address is incorrect
    string public constant INCORRECT_CHARLIE_TREASURER_ADDRESS = "IPOR_402";
    ...
    string public constant CALLER_NOT_PUBLICATION_FEE_TRANSFERER = "IPOR_403";
    ...
    string public constant JOSEPH_SOAP_AND_MILTON_LP_BALANCE_SUM_IS_TOO_LOW = "IPOR_404";

    string public constant TREASURE_BALANCE_TOO_LOW = "IPOR_405";

    //TODO: add test for this code
    //@notice Incorrect Treasure Treasurer Address
    string public constant INCORRECT_TREASURE_TREASURER_ADDRESS = "IPOR_405";
    ...
    string public constant UNDERLYINGTOKEN_IS_NOT_COMPATIBLE = "IPOR_503";

    // only stanley can have access to function
    string public constant CALLER_NOT_STANLEY = "IPOR_504";

    //only milton can have access to function
    string public constant CALLER_NOT_MILTON = "IPOR_505";
