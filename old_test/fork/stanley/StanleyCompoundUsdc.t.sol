...
contract AssetManagementCompoundUsdcTest is Test {
    ...
    function testShouldAcceptDepositAndTransferTokensIntoCompound() public {
        ...
        uint256 strategyCTokenContractBefore = IERC20(amm.cUsdc()).balanceOf(amm.assetManagement().getStrategyCompound());
        ...
        uint256 strategyCTokenContractAfter = IERC20(amm.cUsdc()).balanceOf(amm.assetManagement().getStrategyCompound());
    ...
    function testShouldWithdrawAllAssetManagementBalanceFromCompoundWithdrawMethod() public {
        ...
        uint256 strategyBalanceAfter = IStrategy(amm.assetManagement().getStrategyCompound()).balanceOf();
        uint256 ammTreasuryBalanceAfter = IERC20(amm.usdc()).balanceOf(address(amm.ammTreasury()));
        uint256 strategyATokenContractAfter = IERC20(amm.aUsdc()).balanceOf(amm.assetManagement().getStrategyCompound());
