...
contract MiltonSpreadPremiumVAMRTest is Test, TestCommons {
    ...
    function testShouldCalculateSpreadVolatilityAndMeanReversionPayFixed() public {
        ...
        // when
        vm.prank(_userOne);
        int256 actualResult = _miltonSpread.mockTestCalculateVolatilityAndMeanReversionPayFixed(
            emaVar,
            diffIporIndexEma
        );
        // then
    ...
    function testShouldCalculateSpreadVolatilityAndMeanReversionReceiveFixed() public {
        ...
        // when
        vm.prank(_userOne);
        int256 actualResult = _miltonSpread.mockTestCalculateVolatilityAndMeanReversionReceiveFixed(
            emaVar,
            diffIporIndexEma
        );
        // then
    ...
    function testShouldCalculateSpreadVolatilityAndMeanReversionPayFixedRegionOne() public {
        ...
        // when
        vm.prank(_userOne);
        int256 actualResult = _miltonSpread.mockTestVolatilityAndMeanReversionPayFixedRegionOne(
            emaVar,
            diffIporIndexEma
        );
        // then
    ...
    function testShouldCalculateSpreadVolatilityAndMeanReversionReceiveFixedRegionOne() public {
        ...
        // when
        vm.prank(_userOne);
        int256 actualResult = _miltonSpread.mockTestVolatilityAndMeanReversionReceiveFixedRegionOne(
            emaVar,
            diffIporIndexEma
        );
        // then
    ...
    function testShouldCalculateSpreadVolatilityAndMeanReversionPayFixedRegionTwo() public {
        ...
        // when
        vm.prank(_userOne);
        int256 actualResult = _miltonSpread.mockTestVolatilityAndMeanReversionPayFixedRegionTwo(
            emaVar,
            diffIporIndexEma
        );
        // then
    ...
    function testShouldCalculateSpreadVolatilityAndMeanReversionReceiveFixedRegionTwo() public {
        ...
        // when
        vm.prank(_userOne);
        int256 actualResult = _miltonSpread.mockTestVolatilityAndMeanReversionReceiveFixedRegionTwo(
            emaVar,
            diffIporIndexEma
        );
        // then
