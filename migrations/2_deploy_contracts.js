...
module.exports = async function (deployer, _network, addresses) {
    ...
    if (_network === 'develop' || _network === 'develop2' || _network === 'dev' || _network === 'docker' || _network === 'soliditycoverage') {
        ...
        if (_network !== 'test') { //only public network - test and production
			...
			const INCOME_TAX_PERCENTAGE_ADMIN_ROLE = keccak256("INCOME_TAX_PERCENTAGE_ADMIN_ROLE");
            const OPENING_FEE_FOR_TREASURY_PERCENTAGE_ADMIN_ROLE = keccak256("OPENING_FEE_FOR_TREASURY_PERCENTAGE_ROLE");
            const LIQUIDATION_DEPOSIT_AMOUNT_ADMIN_ROLE = keccak256("LIQUIDATION_DEPOSIT_AMOUNT_ADMIN_ROLE");
            const OPENING_FEE_PERCENTAGE_ADMIN_ROLE = keccak256("OPENING_FEE_PERCENTAGE_ADMIN_ROLE");
            const IPOR_PUBLICATION_FEE_AMOUNT_ADMIN_ROLE = keccak256("IPOR_PUBLICATION_FEE_AMOUNT_ADMIN_ROLE");
            const LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ADMIN_ROLE = keccak256("LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ADMIN_ROLE");
            const MAX_POSITION_TOTAL_AMOUNT_ADMIN_ROLE = keccak256("MAX_POSITION_TOTAL_AMOUNT_ADMIN_ROLE");
            const SPREAD_PAY_FIXED_VALUE_ADMIN_ROLE = keccak256("SPREAD_PAY_FIXED_VALUE_ADMIN_ROLE");
            const SPREAD_REC_FIXED_VALUE_ADMIN_ROLE = keccak256("SPREAD_REC_FIXED_VALUE_ADMIN_ROLE");
            const COLLATERALIZATION_FACTOR_VALUE_ADMIN_ROLE = keccak256("COLLATERALIZATION_FACTOR_VALUE_ADMIN_ROLE");
            const CHARLIE_TREASURER_ADMIN_ROLE = keccak256("CHARLIE_TREASURER_ADMIN_ROLE");
            const TREASURE_TREASURER_ADMIN_ROLE = keccak256("TREASURE_TREASURER_ADMIN_ROLE");
            const ASSET_MANAGEMENT_VAULT_ADMIN_ROLE = keccak256("ASSET_MANAGEMENT_VAULT_ADMIN_ROLE");			
			const DECAY_FACTOR_VALUE_ADMIN_ROLE = keccak256("DECAY_FACTOR_VALUE_ADMIN_ROLE");

            const INCOME_TAX_PERCENTAGE_ROLE = keccak256("INCOME_TAX_PERCENTAGE_ROLE");
            const OPENING_FEE_FOR_TREASURY_PERCENTAGE_ROLE = keccak256("OPENING_FEE_FOR_TREASURY_PERCENTAGE_ROLE");
            const LIQUIDATION_DEPOSIT_AMOUNT_ROLE = keccak256("LIQUIDATION_DEPOSIT_AMOUNT_ROLE");
            const OPENING_FEE_PERCENTAGE_ROLE = keccak256("OPENING_FEE_PERCENTAGE_ROLE");
            const IPOR_PUBLICATION_FEE_AMOUNT_ROLE = keccak256("IPOR_PUBLICATION_FEE_AMOUNT_ROLE");
            const LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ROLE = keccak256("LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ROLE");
            const MAX_POSITION_TOTAL_AMOUNT_ROLE = keccak256("MAX_POSITION_TOTAL_AMOUNT_ROLE");
            const SPREAD_PAY_FIXED_VALUE_ROLE = keccak256("SPREAD_PAY_FIXED_VALUE_ROLE");
            const SPREAD_REC_FIXED_VALUE_ROLE = keccak256("SPREAD_REC_FIXED_VALUE_ROLE");
            const COLLATERALIZATION_FACTOR_VALUE_ROLE = keccak256("COLLATERALIZATION_FACTOR_VALUE_ROLE");
            const CHARLIE_TREASURER_ROLE = keccak256("CHARLIE_TREASURER_ROLE");
            const TREASURE_TREASURER_ROLE = keccak256("TREASURE_TREASURER_ROLE");
            const ASSET_MANAGEMENT_VAULT_ROLE = keccak256("ASSET_MANAGEMENT_VAULT_ROLE");			
			const DECAY_FACTOR_VALUE_ROLE = keccak256("DECAY_FACTOR_VALUE_ROLE");
            ...
            await iporAssetConfigurationUsdc.grantRole(INCOME_TAX_PERCENTAGE_ADMIN_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(INCOME_TAX_PERCENTAGE_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(OPENING_FEE_FOR_TREASURY_PERCENTAGE_ADMIN_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(OPENING_FEE_FOR_TREASURY_PERCENTAGE_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(LIQUIDATION_DEPOSIT_AMOUNT_ADMIN_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(LIQUIDATION_DEPOSIT_AMOUNT_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(OPENING_FEE_PERCENTAGE_ADMIN_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(OPENING_FEE_PERCENTAGE_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(IPOR_PUBLICATION_FEE_AMOUNT_ADMIN_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(IPOR_PUBLICATION_FEE_AMOUNT_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ADMIN_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(MAX_POSITION_TOTAL_AMOUNT_ADMIN_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(MAX_POSITION_TOTAL_AMOUNT_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(SPREAD_PAY_FIXED_VALUE_ADMIN_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(SPREAD_PAY_FIXED_VALUE_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(SPREAD_REC_FIXED_VALUE_ADMIN_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(SPREAD_REC_FIXED_VALUE_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(COLLATERALIZATION_FACTOR_VALUE_ADMIN_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(COLLATERALIZATION_FACTOR_VALUE_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(CHARLIE_TREASURER_ADMIN_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(CHARLIE_TREASURER_ROLE, admin);
            await iporAssetConfigurationUsdc.grantRole(TREASURE_TREASURER_ADMIN_ROLE, admin);
            ...
            await iporAssetConfigurationDai.grantRole(INCOME_TAX_PERCENTAGE_ADMIN_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(INCOME_TAX_PERCENTAGE_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(OPENING_FEE_FOR_TREASURY_PERCENTAGE_ADMIN_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(OPENING_FEE_FOR_TREASURY_PERCENTAGE_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(LIQUIDATION_DEPOSIT_AMOUNT_ADMIN_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(LIQUIDATION_DEPOSIT_AMOUNT_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(OPENING_FEE_PERCENTAGE_ADMIN_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(OPENING_FEE_PERCENTAGE_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(IPOR_PUBLICATION_FEE_AMOUNT_ADMIN_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(IPOR_PUBLICATION_FEE_AMOUNT_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ADMIN_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(LIQUIDITY_POOLMAX_UTILIZATION_PERCENTAGE_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(MAX_POSITION_TOTAL_AMOUNT_ADMIN_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(MAX_POSITION_TOTAL_AMOUNT_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(SPREAD_PAY_FIXED_VALUE_ADMIN_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(SPREAD_PAY_FIXED_VALUE_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(SPREAD_REC_FIXED_VALUE_ADMIN_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(SPREAD_REC_FIXED_VALUE_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(COLLATERALIZATION_FACTOR_VALUE_ADMIN_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(COLLATERALIZATION_FACTOR_VALUE_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(CHARLIE_TREASURER_ADMIN_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(CHARLIE_TREASURER_ROLE, admin);
            await iporAssetConfigurationDai.grantRole(TREASURE_TREASURER_ADMIN_ROLE, admin);
