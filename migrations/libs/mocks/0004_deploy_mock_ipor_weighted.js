...
module.exports = async function (deployer, _network, addresses, MockIporWeighted) {
    ...
    const iporAlgorithmProxy = await deployProxy(MockIporWeighted, [iporOracleProxyAddress], {
        deployer: deployer,
        initializer: "initialize",
        kind: "uups",
    });

    const iporAlgorithmImpl = await erc1967.getImplementationAddress(iporAlgorithmProxy.address);
