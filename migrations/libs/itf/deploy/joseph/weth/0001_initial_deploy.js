...
module.exports = async function (deployer, _network, addresses, ItfJosephWeth, isPaused) {
    ...
    const milton = await func.getValue(keys.ItfMiltonProxyWeth);
    ...
    await func.update(keys.ItfJosephProxyWeth, josephProxy.address);
    await func.update(keys.ItfJosephImplWeth, josephImpl);
};
